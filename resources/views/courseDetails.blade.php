...
@section('content')
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-4">
                    <div class="card card-dark p-2 text-center">
                        ...
                        <p class="lead">Our classes are held in the evening to make sure college schedules do not clash with
                            our classes.</p>
                    </div>
                </div>
                <div class="col-md-4">
    ...
    <section class="p-0">
        <div class="container mb-sm-5 pt-0">
            <div class="row justify-content-center">
                <h2 class="display-5 text-sm-center fw-400 p-3">We built codekaro for <span class="text-prima ck-highlight">
                        college students </span> and they love us</h2>
                <div class="col-md-4 d-flex">
                    <div class="card card-dark p-2 ">
                        ...
                        <p class="">All the interactive live classes with experienced instructors, the sessions with veteran
                ...
                <div class="col-md-4 d-flex">
                    <div class="card card-dark p-2 flex-grow-1">
                        ...
                        <p class="">The mentorship arrangement and the peer culture has helped me evolve as a coder, and I
                ...
                <div class="col-md-4 d-flex">
                    <div class="card card-dark p-2 d-flex">
                        ...
                        <p class="">I still watch the recorded classes of Codekaro, and try to hone my skills more, codekaro
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 text-center">
                    ...
                    <p class="lead">Still have doubts or query, you can simply request callback and our team will get back
