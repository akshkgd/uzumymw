...
@section('content')
{{-- original --}}
<div class="container mx-auto max-w-screen overflow-x-hidden mt-5 px-4 " >
...
<section class="container mx-auto mt-5 max-w-screen overflow-x-hidden">
    <div class=" p-6">
        <input type="text" id="searchInput" onkeyup="searchTable()" placeholder="Search by name, email, or phone number" class="w-ful px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500">
    </div>
    
    <div class=" p-6">
        <h3 class="text-lg font-bold text-gray-800 mb-4">Students Enrolled</h3>
        <div class="overflow-x-auto w-full no-wrap">
            <table class="min-w-full w-full table-auto border rounded-xl border-gray-300" id="enrollmentTable">
    ...
    <div class="bg-white p-6 mt-5">
        ...
        <div class="overflow-x-auto w-full">
            <table class="min-w-full w-full table-auto border rounded-xl border-gray-300" id="enrollmentTable2">
                <thead class="bg-gray-10 border-b">
                    <tr>
