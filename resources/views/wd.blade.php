    ...
    <div class="container ">
        <div class="col-lg-12 mx-auto p-3 ">
            ...
            <main class="text-center mt-5 pt-lg-5">
                ...
                <h4 class="fw-500 py-4"> <strong>Thu, 24th July to 25th July </strong>  | 06:00 PM IST</h3>

                    <div class="my-5">
                        <a href="https://codekaro.in/workshop-enroll/116" class="btn btn-dark btn-lg btn-block px-5">
...
{{-- test --}}
  ...
  let birthday = "july 24, 2022 18:00:00",
