...
<header>
  <nav
      class="fixe top-0 overflow-hidden z-20 w-full bg-white/80 dark:shadow-gray-950/10 border- border-gray-100 border- backdrop-blur">
              ...
              <div class="w-full items-center flex justify-between lg:w-auto">
                  ...
                  <div class="flex lg:hidden">
                      <button aria-label="humburger" id="menu" onclick="toggleMobileMenu()"
                          class="relative border bordeer-gray-950/30 dark:border-white/20 size-9 transition duration-300 active:scale-95">
                          <div aria-hidden="true" id="line1"
                              class="m-auto h-[1.5px] w-4 bg-gray-900 transition duration-300 dark:bg-gray-300">
                          </div>
                          <div aria-hidden="true" id="line2"
                              class="m-auto mt-1.5 h-[1.5px] w-4 bg-gray-900 transition duration-300 dark:bg-gray-300">
                          </div>
                      </button>
                  </div>
              </div>
              <div
                  ...
                  <div class="mt-6 text-ne-600 dark:text-gray-300 md:-ml-4 lg:pr-4 lg:mt-0">
                    ...
                    <ul
                          ...
                          <li>
                              <a href="#"
                                  class="block transition hover:text-whit border border-neutral-400 ring-2 ring-neutral-300 py-2 px-8">
  ...
  <div class="relative sm:py-8 xl:py-12">
      <div class="mx-auto px-6 max-w-6xl md:px-12">
          ...
          <div class="text-center relative z-20 mx-auto sm:w-10/12 lg:w-4/5">
              <div class="inline-flex flex-col sm:flex-row items-center justify-center my-6 sm:mb-4 text-xs sm:text-sm sm:gap-4 gap-2 sm:bg-neutral-100 px-5 py-2">
              ...
              <div class="mt-5 flex flex-row items-center justify-center gap-4">
                  <a href="#"
                      class="group bg-black py-4 px-6 text-white borde border-black hover:text-white transition-all flex items-center gap-2">
...
<section>
  <div class="max-w-3xl mx-auto my-12 sm:my-24 hidde px-4 sm:px-0">
      ...
      <div class="mt-10 flex justify-center gap-10">
          <div class="borde w-96 p-0 sm:p-3">
              <div class="relative">
                  <img src="https://images.ctfassets.net/kftzwdyauwt9/7mxA6Nz8sMAyWaHE7PZcpA/e9e1cd86700761d1d899f49b9aa3547d/mattell-1.1.png?w=3840&q=90&fm=webp" alt="" class="h-48 w-full object-cover">
                  <div class="h-24 w-80 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 justify-center flex gap-1 mt-6">
                     <div class="bg-white h-12 w-12 flex items-center justify-center">
                  ...
                  <!-- <div class="bg-white h-12 w-12 absolute left-1/2 top-1/2 ml-16 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" class="w-sm absolu left-0 origin-center md:w-[28px] BrandIsland_blossom__ZmsAO" width="28" viewBox="0 0 156 154" fill="none"><path d="M59.7325 56.1915V41.6219C59.7325 40.3948 60.1929 39.4741 61.266 38.8613L90.5592 21.9915C94.5469 19.6912 99.3013 18.6181 104.208 18.6181C122.612 18.6181 134.268 32.8813 134.268 48.0637C134.268 49.1369 134.268 50.364 134.114 51.5911L103.748 33.8005C101.908 32.7274 100.067 32.7274 98.2267 33.8005L59.7325 56.1915ZM128.133 112.937V78.1222C128.133 75.9745 127.212 74.441 125.372 73.3678L86.878 50.9768L99.4538 43.7682C100.527 43.1554 101.448 43.1554 102.521 43.7682L131.814 60.6381C140.25 65.5464 145.923 75.9745 145.923 86.0961C145.923 97.7512 139.023 108.487 128.133 112.935V112.937ZM50.6841 82.2638L38.1083 74.9028C37.0351 74.29 36.5748 73.3693 36.5748 72.1422V38.4025C36.5748 21.9929 49.1506 9.5696 66.1744 9.5696C72.6162 9.5696 78.5962 11.7174 83.6585 15.5511L53.4461 33.0352C51.6062 34.1084 50.6855 35.6419 50.6855 37.7897V82.2653L50.6841 82.2638ZM77.7533 97.9066L59.7325 87.785V66.3146L77.7533 56.193L95.7725 66.3146V87.785L77.7533 97.9066ZM89.3321 144.53C82.8903 144.53 76.9103 142.382 71.848 138.549L102.06 121.064C103.9 119.991 104.821 118.458 104.821 116.31V71.8343L117.551 79.1954C118.624 79.8082 119.084 80.7289 119.084 81.956V115.696C119.084 132.105 106.354 144.529 89.3321 144.529V144.53ZM52.9843 110.33L23.6911 93.4601C15.2554 88.5517 9.58181 78.1237 9.58181 68.0021C9.58181 56.193 16.6365 45.611 27.5248 41.163V76.1299C27.5248 78.2776 28.4455 79.8111 30.2854 80.8843L68.6271 103.121L56.0513 110.33C54.9781 110.943 54.0574 110.943 52.9843 110.33ZM51.2983 135.482C33.9681 135.482 21.2384 122.445 21.2384 106.342C21.2384 105.115 21.3923 103.888 21.5448 102.661L51.7572 120.145C53.5971 121.218 55.4385 121.218 57.2784 120.145L95.7725 97.9081V112.478C95.7725 113.705 95.3122 114.625 94.239 115.238L64.9458 132.108C60.9582 134.408 56.2037 135.482 51.2969 135.482H51.2983ZM89.3321 153.731C107.889 153.731 123.378 140.542 126.907 123.058C144.083 118.61 155.126 102.507 155.126 86.0976C155.126 75.3617 150.525 64.9336 142.243 57.4186C143.01 54.1977 143.471 50.9768 143.471 47.7573C143.471 25.8267 125.68 9.41567 105.129 9.41567C100.989 9.41567 97.0011 10.0285 93.0134 11.4095C86.1112 4.66126 76.6024 0.367188 66.1744 0.367188C47.6171 0.367188 32.1282 13.5558 28.5994 31.0399C11.4232 35.4879 0.380859 51.5911 0.380859 68.0006C0.380859 78.7365 4.98133 89.1645 13.2631 96.6795C12.4963 99.9004 12.036 103.121 12.036 106.341C12.036 128.271 29.8265 144.682 50.3777 144.682C54.5178 144.682 58.5055 144.07 62.4931 142.689C69.3938 149.437 78.9026 153.731 89.3321 153.731Z" fill="currentColor"></path></svg>
                  </div> -->
              </div>
...
<!-- feedbacks -->
<div class="max-w-7xl mx-auto mt-12 mb-12 hidde px-4 sm:px-12">
  ...
  <div class="columns-1 sm:columns-2 lg:columns-3 gap-6 space-y-6">
      <div class="break-inside-avoid feedback-card bg-white borde">
          <video class="" controls muted autoplay loop
      ...
      <!-- Feedback 3 -->
      <div class="break-inside-avoid p-3 feedback-card bg-white border">
          <div class="flex mb-3 justify-content-between align-items-center">
              <div class="flex items-center gap-3">
                  <img loading="lazy" src="https://codekaro.in/assets/img/cssf5.jpeg"
                      class="avatar-sm-sm w-12 h-12" alt="Cherish Vuppala">
                  <div>
      ...
      <!-- Feedback 4 -->
            <div class="break-inside-avoid feedback-card bg-white border">
        <div class="border-b border-neutral-200">
            <div class="p-3">
                <h2 class="cal-sans font-semibold"><span class="text-4xl">190%</span> <span class="font-light font-sans">Hike</span> </h2>
            </div>
        </div>
          <div class="flex mb-3 justify-content-between align-items-center">
              <div class="flex items-center gap-3 p-3">
                  <div class="w-12 h-12 rounded-full overflow-hidden">
                    <img loading="lazy" src="https://codekaro.in/assets/img/feedbacks/pruthviraj.jpeg"
                      class="w-12 h-12 object-cover rounded-none" alt="Pruthviraj">  
                    </div>
                  <div>
                      <p class="m-0 text-dark font-medium">Pruthviraj</p>
                      <p class=" text-sm text-neutral-600">Senior Software Engineer, JP Morgan</p>
                  </div>
              </div>
          </div>
          <div class="px-3 pb-4 pt-1 space-y-2">
              <p class="text-neutral-800 text-sm">
                  <span class="text-neutral-500 text-xs tracking-wider mr-2 font-normal uppercase">BEFORE:</span>Backend Engineer, Ericsson
              </p>
              <p class="text-neutral-800 text-sm">
                  <span class="text-neutral-500 text-xs tracking-wider mr-2 font-normal uppercase">NOW:</span>Computer Scientist, Adobe
              </p>
              
              <div class="flex items-center justify-between pt-4 pb-2">
                  <div class="border border-neutral-200 px-4 py-2 text-xs tracking-wider text-black">
                      2 OFFERS
                  </div>
                  <a href="#" class="text-blue-800  text-sm flex items-center gap-1">
                      Explore more <span class="text-base">&rarr;</span>
                  </a>
              </div>
          </div>
      </div>
      ...
      <div class="break-inside-avoid feedback-card bg-white border">
        <div class="border-b border-neutral-200">
            <div class="p-3">
                <h2 class="cal-sans font-semibold"><span class="text-4xl">132%</span> <span class="font-light font-sans">Hike</span> </h2>
            </div>
        </div>
          <div class="flex mb-3 justify-content-between align-items-center">
              <div class="flex items-center gap-3 p-3">
                  <div class="w-12 h-12 rounded-full overflow-hidden">
                    <img loading="lazy" src="https://codekaro.in/assets/img/cssf3.jpeg"
                      class="w-12 h-12 object-cover rounded-none" alt="Manjiri Pund">
                    </div>
                  <div>
                      <p class="m-0 text-dark font-medium">Manjiri Pund</p>
                      <p class=" text-sm text-neutral-600">Data Engineer, Amazon, BITS Pilani</p>
                  </div>
              </div>
          </div>
          <p class="text p-3 text-sm text-neutral-900">I am overwhelmed to share that I have completed the CSS bootcamp conducted by
      ...
      <div class="break-inside-avoid feedback-card bg-white borde">
          <!-- <video class="" controls muted autoplay loop src="https://framerusercontent.com/assets/YrPucpqB3PiKHVl8mLAwUmqbE.mp4"></video> -->
      </div>
  </div>
</div>
<!-- feedback ends -->
...
<div id="mobilePopup" class="lg:hidden fixed inset-0 bg-white z-50 transform translate-x-full transition-transform duration-300 ease-in-out">
    ...
    <div class="flex items-center justify-between p-3 border- border-neutral-200">
        ...
        <button onclick="toggleMobileMenu()" class="p-2 hover:bg-neutral-100 transition-colors duration-200">
    ...
    <div class="flex flex-col h-full">
        ...
        <div class="p-4 border-t border-neutral-200 space-y-3">
            @guest
                <a href="{{url('/login')}}" 
                   class="w-full flex mb-3 justify-center items-center px-4 py-3 border border-transparent text-sm font-medium text-white bg-black hover:bg-neutral-800 transition-colors duration-200">
                    Login
                </a>
                <a href="#" 
                   class="w-full flex justify-center items-center px-4 py-3 border border-neutral-300 text-sm font-medium text-neutral-800 bg-white hover:bg-neutral-50 transition-colors duration-200">
                    Book Demo Session
                </a>
            @endguest
            ...
            @auth
                <a href="{{url('/home')}}" 
                   class="w-full flex justify-center items-center px-4 py-3 border border-transparent text-sm font-medium text-white bg-black hover:bg-neutral-800 transition-colors duration-200">
                    My Dashboard
                </a>
                <a href="#" 
                   class="w-full flex justify-center items-center px-4 py-3 border border-neutral-300 text-sm font-medium text-neutral-800 bg-white hover:bg-neutral-50 transition-colors duration-200">
