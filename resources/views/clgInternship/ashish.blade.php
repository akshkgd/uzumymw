                    ...
                    <div class="card-body ">
                        ...
                        <div class="row pb-0 pt-4">
                            ...
                            <div class="col-sm-4 text-md-right text-center px-5 mt-5">
                                ...
                                <h6 class=" ck-font m-0" style="color:#4185f4;">Certificate Id : 8be76c72dffcb7c6</h5>
                                    <p style="font-size: 14px" class="ck-font m-0">Verify the authenticity of this certificate <a href="https://codekaro.in/internship-certificate/8be76c72dffcb7c6" target="_blank">using this link</a></h6>
                            </div>
                        </div>
