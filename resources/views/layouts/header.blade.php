    ...
    <div class="d-flex align-items-center order-lg-3">
      ...
      <div class="d-non collapse  input-group">
        ...
        @auth
            <div class="dropdown ml-2">
                @if (Auth::user()->google_id == '')
                    <img src="{{ asset(Auth::user()->avatar) }}" alt="User" class="avatar avatar-sm dropdown-toggle"
                        data-toggle="dropdown" data-hover="true" aria-haspopup="true" aria-expanded="false">
                @else
                    <img src="{{ Auth::user()->avatar }}" alt="User" class="avatar avatar-sm dropdown-toggle"
                        data-toggle="dropdown" data-hover="true" aria-haspopup="true" aria-expanded="false">
                @endif
        ...
        @guest
            ...
            <a href="{{ url('/redirect') }}" class="btn btn-primary-3 ml-2 fw-400" style="letter-spacing: 0;">Try for
                Free</a>
        @endguest
        <div class="ml-2">
        ...
        <div class="py-2 py-lg-0">
            <ul class="navbar-nav">
                ...
                @auth
                    ...
                    @if (Auth::user()->role == 1)
                        <li class="nav-item"><a href="{{ url('/my-classes') }}" class="nav-link">My Classes</a></li>
                        <li class="nav-item"><a href="{{ url('/my-workshops') }}" class="nav-link">My Workshops</a></li>
