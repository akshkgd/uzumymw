      ...
      <div class="row">
        ...
        <div class="col-lg-6 text-right">
          <ul class="d-flex justify-content-center justify-content-lg-end text-dark m-0 p-0" type="none">
            ...
            <li class="nav-item">
              <a class="nav-link text-dark" target="_blank" href="https://facebook.com/codekaro.in"><img height="30" src="{{asset('assets/img/facebook.svg')}}" alt=""></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link text-dark fs-5" target="_blank" href="https://twitter.com/akshkgd"><img height="30" src="{{asset('assets/img/twitter.svg')}}" alt=""></a>
            </li>
          </ul>
        </div>
      </div>
