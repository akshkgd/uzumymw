    ...
    >
      <div class="flex items-center justify-between w-full px-5  mx-auto 2xl:px-0  py-1">
        ...
        <div class="flex gap-3 items-center">
          ...
          <form method="post" action="{{ route('users.search') }}" class="fle hidden items-center">
            <input type="text" name="query" placeholder="Search user" class="w-fu text-s px-4 py-2 border-l border-t border-b border-neutral-200 rounded-l-lg focus:outline-none focus:">
            <button  type="submit" class="bt text-white px-4 py-2  border-t border-b border-r rounded-r-lg"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="black" class="size-6">
