...
class="fixed top-0 left-0 w-full z-[20] flex flex-col">
    ...
    <header id="sticky-header"
      class="relative h-14 flex items-center justify-center w-full duration-500 ease-out bg-white border-b bg-opacity-90 backdrop-blur-md border-neutral-200 border-opacity-40">
    ...
    <template x-teleport="body">
        <div x-show="featureRequestModalOpen" class="fixed top-0 left-0 z-[9999] flex items-center justify-center w-screen h-screen" x-cloak>
