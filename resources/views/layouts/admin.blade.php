...
<head>
    ...
    <title>Codekaro Admin Panel</title>
...
<body class="with-custom-webkit-scrollbars with-custom-css-scrollbars" data-dm-shortcut-enabled="true" data-sidebar-shortcut-enabled="true" data-set-preferred-theme-onload="true" onload="toastAlert()">
    ...
    <div id="page-wrapper" class="page-wrapper with-navbar with-sidebar" data-sidebar-type="overlayed-sm-and-down">
        ...
        <nav class="navbar">
            ...
            <a href="{{url('/home')}}" class="navbar-brand ml-10 ml-sm-15">Codekaro
            ...
            <div class="navbar-content ml-auto ">
                {{-- <form class="form-inline ml-auto mr-10" action="..." method="..."> <!-- ml-auto = margin-left: auto --> --}}
                    <form method="POST" class="form-inline ml-auto mr-10" action="{{ route('search')}}" >
                    @csrf
                    <div class="input-group">
                      <input type="text"  id="search_value" name="search_value" class="form-control" placeholder="Search User" required="required">
                      <div class="input-group-append">
                        <button class="btn" type="submit">
                          <i class="fa fa-search" aria-hidden="true"></i>
                          
                          {{-- <span class="sr-only">Search User</span> <!-- sr-only = show only on screen readers --> --}}
                        </button>
                      </div>
                    </div>
                  </form>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-menu list">
                ...
                <a href="{{url('/purchase')}}" class="sidebar-link" id="sidebar-download" data-active-scroll-disabled="disabled">
                    <span class="name">Enrollment Details</span>
                </a>
                ...
                <a href="{{url('admin/batches')}}" class="sidebar-link" id="sidebar-containers" data-active-scroll-disabled="disabled">
                    <span class="name">Batch Details</span>
                </a>
                <a href="{{url('/admin/create/batch')}}" class="sidebar-link" id="sidebar-content-and-cards" data-active-scroll-disabled="disabled">
                    <span class="name">Add New Batch</span>
                </a>
                ...
                <a href="{{url('/faqs')}}" class="sidebar-link" id="sidebar-containers" data-active-scroll-disabled="disabled">
                    <span class="name">Distribution Details</span>
                </a>
                <a href="{{url('/faqs/create')}}" class="sidebar-link" id="sidebar-content-and-cards" data-active-scroll-disabled="disabled">
    ...
    <!-- Halfmoon JS -->
    <script src="{{asset('assets/js/halfmoon.min.js')}}"></script>
    <!-- Script -->
