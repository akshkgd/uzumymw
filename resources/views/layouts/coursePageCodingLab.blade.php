<script src="https://cdn.jsdelivr.net/npm/monaco-editor@0.44.0/min/vs/loader.js"></script>
  <style>
    ...
    body.dark-mode .console-line:hover {
  ...
  <div class="flex flex-col h-[calc(100vh-56px)] mt-[56px]" id="container">
    ...
    <div class="flex justify-between items-center px-4 py-2 border-b border-neutral-200">
      ...
      <div class="flex items-center gap-4">
        ...
        <button id="submitBtn" onclick="submitCode()" class="bg-black text-white px-4 py-2 rounded-lg hover:bg-neutral-900 transition-colors flex items-center gap-2">
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <!-- Problem, Console and Feedback -->
      <div class="2xl:flex hidde w-[420px] h-full border-l overflow-hidden flex-col">
        <!-- Tab Headers -->
        <div class="flex border-b">
          <button id="problemTab" onclick="switchTab('problem')" class="flex-1 px-4 py-3 flex items-center justify-center gap-2 border-b-2 border-black bg-gray-50">
          ...
          <button id="consoleTab" onclick="switchTab('console')" class="flex-1 px-4 py-3 flex items-center justify-center gap-2 border-b-2 border-transparent hover:bg-gray-50">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
            <span class="font-medium text-sm">Console</span>
          </button>
          <button id="feedbackTab" onclick="switchTab('feedback')" class="flex-1 px-4 py-3 flex items-center justify-center gap-2 border-b-2 border-transparent hover:bg-gray-50">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- Console Section -->
        <div id="consoleSection" class="flex-1 overflow-hidden flex-col hidden">
...
console.log("Hello, World!");`;
    ...
    function switchTab(tab) {
      ...
      // Reset all tabs
      [problemTab, consoleTab, feedbackTab].forEach(tabEl => {
      ...
      // Hide all sections
      [problemSection, consoleSection, feedbackSection].forEach(section => {
      ...
      if (tab === 'problem') {
        ...
        consoleTab.classList.add('border-black', 'bg-gray-50');
        consoleTab.classList.remove('border-transparent');
        consoleTab.querySelector('svg').classList.remove('text-gray-500');
        consoleTab.querySelector('svg').classList.add('text-gray-700');
        consoleSection.classList.remove('hidden');
        consoleSection.classList.add('flex');
