                    ...
                    <div class="relative w-full max-w-md mx-auto py-8">
                        <div class="relative text-center p-3 sm:p-6">
                            <div class="flex flex-col mb-6 space-y- text-center">
                                ...
                                <p class="text-sm text-red-600 -mt- font-medium">Live class from 24th Nov | 08:00 PM</p>
                            </div>
            ...
            <div class="w-[90%] md:w-4/5 mx-auto bg-cover bg-white bg-center bg-[url('/assets/img/genAiLP/ctherom.webp')] md:bg-[url('/assets/img/genAiLP/newhero.svg')] border border-[#041B014D] md:p-8">
                <div class="flex items-center justify-center md:mb-8 mb-4 pt-4">
                    ...
                    <div class="flex flex-col items-center text-center py-5">
                        <div class="text-black bg-[#EEFE05] text-sm font-figtree font-normal mb-4 p-2 border border-[#07090166]">10 Hours ◆ 5 LIVE EXPERT SESSIONS</div>
                        <h1 class="text-2xl md:text-[34px] font-medium mb-4 font-mackinac px-3">5 DAY GEN AI ENGINEERING MASTERMIND</h1><p class="text-gray-700 text-14 md:text-[22px] w-[80%] mb-4 font-figtree font-normal">Master Gen AI in <span class="font-semibold">5 days</span>, from API Integration to Building Gen AI Application. Boost your engineering skills with hands-on learning, whether you're a beginner or already working with Gen AI.</p>
    ...
    <section>
        <section class="my-24 mb-32">
            <div class="w-[90%] md:w-4/5 mx-auto text-center">
                <div class="text-left mb-8"><h3 class="text-sm font-figtree font-medium text-neutral-600 uppercase">Curriculum</h3><h2 class="text-[24px] sm:text-[32px] font-medium font-mackinac">What will you learn in 5 days?</h2></div>
                ...
                <div class="border border-neutral-300  bg-white w-full  " >
                    <div class="p-3">
                        ...
                        <h1 class="font-medium text-lg">CSS Fundamentals</h1>
                ...
                <div class="border border-neutral-300 bg-white  w-full">
                    <div class="p-3">
                        ...
                        <h1 class="font-medium text-lg">Understand Javascript</h1>
                        <ul class="mt-2 list-disc ml-4 text-neutral-700">
                            <li>Understanding Js</li>
                            <li>Variables</li>
                            <li>Arrays and object</li>
                ...
                <div class="border border-neutral-300  bg-white w-full ">
                    <div class="p-3">
                        ...
                        <h1 class="font-medium text-lg">Building AI Chatbot</h1>
                        <ul class="mt-2 list-disc ml-4 text-neutral-700">
                            <li>Understanding APIs</li>
                            <li>Javascript API Calls With requests</li>
                            <li>ChatGPT API Fundamentals</li>
                            <li>Using ChatGPT with Javascript</li>
                            <li>Build Your Custom AI Chatbot</li>
                        </ul>
                    </div>
                    <div class="border-t border-neutral-300 bg-cover bg-center bg-[#f9fee " style="background-image: url(&quot;/assets/img/genAiLP/back.svg&quot;);">
                ...
                <div class="border border-neutral-300  bg-white w-full ">
                    <div class="p-3">
                        ...
                        <h1 class="font-medium text-lg">Scalable React App</h1>
                        <ul class="mt-2 list-disc ml-4 text-neutral-700">
                            <li>React js Setup</li>
                            <li>Props and JSON Data</li>
                ...
                <div class="border border-neutral-300  bg-white w-full ">
                    <div class="p-3">
                        ...
                        <h1 class="font-medium text-lg">Building Notebook LM</h1>
                        <ul class="mt-2 list-disc ml-4 text-neutral-700">
                            <li>Understanding APIs</li>
                            <li>Axios API Calls With requests</li>
                            <li>ChatGPT API Setup</li>
                            <li>How to train GPT</li>
                            <li>How to build custom GPT</li>
                        </ul>
                    </div>
                    <div class="border-t border-neutral-300 bg-cover bg-center bg-[#f9fee " style="background-image: url(&quot;/assets/img/genAiLP/back.svg&quot;);">
                        <div class="p-3 ">
