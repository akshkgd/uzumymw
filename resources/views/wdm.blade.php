...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
        <div class="container">
          <a class="navbar-brand fw-700 wd_highlight fs-4" href="#">
             Codekaro
          </a>
    ...
    <div class="container ">
        <div class="col-lg-10 mx-auto p-3 ">
            ...
            <main class="text-center mt-5 ">
                <h1 class="titl display-3 fw-700">Get started with 30 days <span class="wd_highlight">Web Development</span> Bootcamp</h1>
...
{{-- test --}}
  ...
  let birthday = "Nov 23, 2021 24:00:00",
