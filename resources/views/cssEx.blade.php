...
<body class="" x-data="{ 
                    ...
                    <div class="relative w-full max-w-md mx-auto py-8">
                        <div class="relative text-center p-3 sm:p-6 ">
                            <div class="flex flex-col mb-6 space-y- text-center">
                                ...
                                <p class="text-sm text-red-600 -mt- font-medium">Live class from 1st Dec | 08:00 PM</p>
                            </div>
                            <form class="space-y-3 text-left  mt-10" action="https://codekaro.in/course-enrollment-auto" method="POST" id="enrollmentForm" @submit.prevent="validateAndSubmit">
                                ...
                                <input type="hidden" name="courseId" value="163">
                                <div class="space-y-1">
                                ...
                                <div class="hidden space-y-1 mt-3  border-2 border-green-500 bg-orange-5 rounded-x p-4 pb-3">
                                    ...
                                    <div class="fle items-center justify-between mt-4">
                                        <div class="flex items-center gap-2 mt-2">
                                            <span class="text-l font-semibold">Free.00</span>
                                        ...
                                        <label class="relative inline-flex items-center cursor-pointer mt-2">
                                            ...
                                            <span class="ml-3 text-sm font-medium text-neutral-700">Add VIP Upgrade for Free</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="flex flex-col-reverse sm:flex-row sm:justify-between sm:space-x-2">
                                    <button type="submit" class="text-center w-full md:w-auto bg-[#FAFF00] hover:bg-[#E5E500] text-black font-medium py-2 px-8 border border-black text-base sm:text-xl font-figtree">
                                        Join Gen AI Engineering Mastermind for just  <span x-text="vipUpgrade ? ' ₹398 ' : ' Free '"></span>
                                    </button>
                                </div>
                            </form>
                    ...
                    <div class="flex flex-col items-center text-center py-5">
                        ...
                        <div class="text-black bg-[#EEFE05] text-sm font-figtree font-normal mb-4 p-2 border border-[#07090166]">For Active Coders &amp; Working Professionals</div><div class="flex flex-wrap justify-center gap-6 text-sm mb-6 md:w-[90%] w-[100%]">
                            <section class="w-full py-2 px-4 text-center"><div class="max-w-5xl mx-auto">
                                ...
                                <a href="#_" @click="modalOpen=true" class="mt-6 bg-[#F1FE06] text-black px-6 py-3 border border-[#07090166] font-figtree font-normal w-[80%] md:w-[60%] text-center">Grab Your Spot For Free</a></div></div></div>
    </section>
    {{-- logos --}}
        ...
        <section class="my-24 mb-32">
            <div class="w-[90%] md:w-4/5 mx-auto text-center">
                ...
                <div class="border border-neutral-300  bg-white w-full  " >
                    <div class="borde border-b p-3" style="background-image: url(&quot;/assets/img/genAiLP/back.svg&quot;);">
                        <p class="text-sm text-neutral-600 my-2">Day 01</p>
                        <h1 class="font-medium text-lg">Introduction to CSS</h1>
                    </div>
                    <div class="p-3">
                        ...
                        <ul class="mt-2 list-disc ml-4 text-neutral-700">
                            ...
                            <li>Typography</li>
                            <li>Box Model & Usecases</li>
                            <li>Creating login and feedback pages</li>
                            <li>Understanding Usecases</li>
                        </ul>
                    </div>
                </div>
                <div class="border border-neutral-300  bg-white w-full  " >
                    <div class="borde border-b p-3" style="background-image: url(&quot;/assets/img/genAiLP/back.svg&quot;);">
                        ...
                        <h1 class="font-medium text-lg">Mastering Positions</h1>
                    </div>
                    <div class="p-3">
                ...
                <div class="border border-neutral-300  bg-white w-full  " >
                    <div class="borde border-b p-3" style="background-image: url(&quot;/assets/img/genAiLP/back.svg&quot;);">
                        ...
                        <h1 class="font-medium text-lg">Master Flexbox</h1>
                    </div>
                    <div class="p-3">
                        ...
                        <ul class="mt-2 list-disc ml-4 text-neutral-700">
                            ...
                            <li>Understanding Usecases</li>
                            <li>Creating a zomato clone</li>
                            <li>Airbnb Case Studies</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="border border-neutral-300  bg-white w-full  " >
                    <div class="borde border-b p-3" style="background-image: url(&quot;/assets/img/genAiLP/back.svg&quot;);">
                        <p class="text-sm text-neutral-600 my-2">Day 04</p>
                        <h1 class="font-medium text-lg">Master Responsive designs</h1>
                    </div>
                    <div class="p-3">
                        
                        <ul class="mt-2 list-disc ml-4 text-neutral-700">
                            <li>Media Queries</li>
                            <li>Media queries examples and usecases</li>
                            <li>Creating Animations</li>
                            <li>Using animations in real world examples.</li>
                            <li>Animations Libraries</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="border border-neutral-300  bg-white w-full  " >
                    <div class="borde border-b p-3" style="background-image: url(&quot;/assets/img/genAiLP/back.svg&quot;);">
                        <p class="text-sm text-neutral-600 my-2">Day 05</p>
                        <h1 class="font-medium text-lg">Major Project: Create Instagram Clone</h1>
                    </div>
                    <div class="p-3">
                        
                        <ul class="mt-2 list-disc ml-4 text-neutral-700">
                            <li>Building Instagram Cloning</li>
                            <li>Adding Media Queries</li>
                            <li>Adding Animations</li>
                            <li>LinkedIn shareable certificate</li>
                            <li>Bonus: Full stack Roadmap</li>
                        </ul>
                    </div>
                </div>
  ...
  },
  {
    ...
    <div class="fixed bottom-0 left-0 w-full bg-white border-t border-gray-300 shadow-lg z-50"><div class="w-[90%] md:w-[80%] mx-auto py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-4 sm:space-y-0"><div class="w-full flex flex-row md:items-start items-center justify-center sm:justify-start space-y-0 md:space-y-2 sm:space-x-4 gap-3"><div class="flex flex-col md:items-start"><div class="flex flex-row sm:flex-col sm:items-start sm:space-y-1 items-center"><p class="text-[18px] sm:text-[28px] font-mackinac font-medium text-black leading-tight flex items-center"><span class="text-black text-[22px] sm:text-[28px] font-bold">Free</span> <span class="text-gray-500 line-through text-[16px] sm:text-[20px] ml-1">₹2,290</span></p><p class="text-[14px] sm:text-[18px] font-figtree flex items-center ml-2 sm:ml-0 sm:items-start"><span role="img" aria-label="alarm-clock" class="mr-1">⏳</span>Offer Ends in: <span class="font-semibold ml-1 sm:ml-0"><span x-text="minutes"></span>:<span x-text="seconds.toString().padStart(2, '0')"></span></span></p></div></div></div><a href="#_" @click="modalOpen=true" class="text-center w-full md:w-auto bg-[#FAFF00] hover:bg-[#E5E500] text-black font-medium py-2 px-8 border border-black text-base sm:text-xl font-figtree">Grab Your Spot For just Free</a></div></div>
