...
<section>
  <div class="max-w-xl mx-auto mt-44 text-cente shadow-l text-center sm:text-left rounded-xl">
    <h1 class="sm:text-2xl text-xl font-semibold">Welcome to the top 1% building with AI 🚀 @auth {{Auth::user()->name}} @endauth <span class="text-2xl"></span></h1>
    <p class=" font-ligh text-gray-700 sm:text-xl mt-3 px-5 sm:p-0">Over the next 2 days, you’ll build your own AI chatbot,  AI agent from scratch. Live classes will start from <span class="underline font-semibold text-black">21st March, 07:00 PM.</span> </p>
    <div class="fixed bottom-0 mb-10 w-full sm:static">
        <p class="   text-gray-700  sm:hidden">Next Steps</p>
      <a target="_blank" href="https://chat.whatsapp.com/HoL8DDZXKbR2l8jwuJpfgl" class="text-white bg-green-600 py-4 px-16 mt-4 inline-block rounded-full sm:rounded-xl  transition-all hover:bg-green-700 hover:text-white text-lg">Join the Private WhatsApp Group</a>
      <p class="text-sm block mt-3 text-neutral-700 sm:hidden">Join the WhatsApp group now <br>  to receive Zoom links and updates.</p>
      <p class="text-sm hidden sm:block mt-3 text-neutral-700">This is where we’ll share:

Live class links, Resources & Important updates. Join now to avoid missing anything</p>
