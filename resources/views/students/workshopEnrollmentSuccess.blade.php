            ...
            <div class="col-lg-7">
                <div class="card f-1 text-center ">
                    <div class="p-3">
                      ...
                      <a href="{{$workshop->groupLink}}" class="btn btn-success btn-lg py-3 px-4 rounded-pill" style="background-color: #25D366; border:1px solid #25D366;">Join WhatsApp Group Now</a>
                    </div>
