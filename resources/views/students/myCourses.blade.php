          ...
          <div class="col-md-6 col-lg-4 d-flex">
            ...
            <div class="card card-dar card-bod">
              <div class="flex-grow-1">
                ...
                {{-- <h1 class="lead-1 mb-2">{{$Enrollment->batch->name}}</h4> --}}
                  <div class="pt-2 p-2">
                    @if($Enrollment->batch->status == 0)
                    @if ($Enrollment->hasPaid == 0)
                    <p class="lead">Start Date: {{Carbon\Carbon::parse($Enrollment->batch->startDate)->format('D, d M Y')}}</p>
              ...
              <div class="progress mb-3 m-2">
                <div class="progress-bar " role="progressbar" style="width: {{$Enrollment->courseProgress}}%" aria-valuenow="{{$Enrollment->courseProgress}}" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
              <div class="d-md-fl p-2">
                <a href="#" class=""><span class="badge badge-pill badge-primary bg-primary-alt-2 text-primary  mt-1 lead ">Upcoming</span> </a>
                <a href="#" class=""><span class="badge badge-pill badge-primary bg-primary-alt-2 text-primary  mt-1 lead ">Upcoming Classes </span> </a>
              <a href="#" class=""><span class="badge badge-pill badge-primary bg-primary-3-alt text-primary  mt-1 lead">Upcoming Classes</span></a>
              </div>
