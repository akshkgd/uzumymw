        ...
        <div x-show="modalOpen" class="fixed top-0 left-0 z-[99] flex items-center justify-center w-screen h-screen" x-cloak>
            ...
            <div x-show="modalOpen"
                ...
                <div class="relative w-auto">
                    <a href="{{$enrollment->batch->groupLink}}" class="p-3 bg-neutral-100 my-2 block w-full rounded-lg  hover:bg-neutral-50 cursor-pointer">Join telegram group</a>
                    <a href="{{$enrollment->batch->groupLink1}}" class="p-3 bg-neutral-100 my-2 block w-full rounded-lg hover:bg-neutral-50 cursor-pointer">Join discussion channel</a>
                    <a href="https://cal.com/ashish-shukla-ye5ege/onboarding-process-with-ashish" class="block w-full p-3 bg-neutral-100 my-2 rounded-lg hover:bg-neutral-50 cursor-pointer">Book one on one Session</a>
