...
<section>
  <div class="max-w-xl mx-auto mt-44 text-cente shadow-l text-center sm:text-left rounded-xl">
    ...
    <p class=" font-ligh text-gray-700 sm:text-xl mt-3 px-5 sm:p-0">You have successfully enrolled for the <span class="underlin text-blac">How to CSS Bootcamp</span>. Live classes will start from <span class="underline font-semibold text-black">{{ \Carbon\Carbon::parse($batch->nextClass)->format('D, d M h:i a') }} IST</span> </p>
    <div class="fixed bottom-0 mb-10 w-full sm:static">
        <p class="   text-gray-700  sm:hidden">Next Steps</p>
      <a target="_blank" href="{{$batch->groupLink}}" class="text-white bg-green-600 py-4 px-16 mt-4 inline-block rounded-full sm:rounded-xl  transition-all hover:bg-green-700 hover:text-white text-lg">Join WhatsApp Group</a>
