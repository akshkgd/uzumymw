...
<section>
  <div class="max-w-xl mx-auto mt-44 text-cente shadow-l p-5 sm:p-16 text-center sm:text-left rounded-xl">
    ...
    <p class=" font-ligh text-gray-700 text-lg mt-3">You have successfully enrolled for the <span class="underlin text-blac">How to CSS Bootcamp</span>. Live classes will start from <span class="underlin font-semibold text-black">{{ \Carbon\Carbon::parse($batch->startDate)->format('D, d M H:i a') }} IST</span> </p>
