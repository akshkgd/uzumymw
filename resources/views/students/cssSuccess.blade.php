...
<section>
            ...
            <div class="col-lg-7">
                <div class="card f-1 text-center ">
                    <div class="p-3">
                      ...
                      <a href="https://chat.whatsapp.com/GY1KeTEx5Fm2lvcCDMZpjl" class="btn btn-success btn-lg py-3 px-5 rounded-pill my-2" style="background-color: #25D366; border:1px solid #25D366;">Join WhatsApp Group Now</a>
    ...
    <section class="">
        <div class="container text-center ct">
            ...
            <h2>Monday, 1st April at 08:00 PM IST</h2>
            <div id="countdown">
              {{-- <ul>
