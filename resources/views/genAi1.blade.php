                    ...
                    <div class="relative w-full max-w-md mx-auto py-8">
                        <div class="relative text-center p-3 sm:p-6 ">
                            <div class="flex flex-col mb-6 space-y- text-center">
                                ...
                                <h1 class="text-xl font-semibold tracking-tight font-sans flex gap-1 justify-center">Join Live Gen AI Engineering Mastermind</h1>
                                <p class="text-sm text-red-600 -mt- font-medium">Live class from 14th March | 07:00 PM</p>
                            </div>
            ...
            <div class="w-[100%] md:w-4/5 mx-auto bg-cover bg-white bg-center bg-[url('/assets/img/genAiLP/ctherom.webp')] md:bg-[url('/assets/img/genAiLP/newhero.svg')] border md:border-[#041B014D] md:p-8">
                <div class="flex items-center justify-center md:mb-8 mb-4 pt-4">
                    ...
                    <div class="flex flex-col items-center text-center py-5">
                        <div class="text-black bg-[#EEFE05 text-sm font-figtree font-normal mb-4 p-2 border border-[#07090166]">For Active Coders &amp; Working Professionals</div>
                        <h1 class="text-2xl md:max-w-3xl md:text-[30px] font-medium mb-4 font-mackinac">Build Your Own AI Agent in 2 days — Even If You’re Starting From Zero</h1><p class="text-gray-700 text-14 md:text-[20px] w-[80%] mb-4 font-figtree font-normal">No fluff. No theory.
You’ll go from LLM fundamentals to  API Integration to a working AI agent you can actually show, ship, or monetize.</p>
                        <div class="text-black hidden bg-[#EEFE05 text-sm font-figtree font-normal mb-4 p-2 border border-[#07090166]">For Active Coders &amp; Working Professionals</div><div class="flex flex-wrap justify-center gap-6 text-sm mb-6 md:w-[90%] w-[100%]">
                            <section class="w-full py-2 px-4 text-center"><div class="max-w-5xl mx-auto"><div class="w-full flex items-center justify-center"></div><div class="flex flex-col md:flex-row gap-4 md:gap-3 justify-center w-full"><div class="border border-black p-2 py-4 flex-1 flex justify-center items-center text-center"><div class="flex flex-row md:flex-row items-center gap-2 text-sm md:text-lg font-mackina"><div class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar-days md:size-6"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect width="18" height="18" x="3" y="4" rx="2"></rect><path d="M3 10h18"></path><path d="M8 14h.01"></path><path d="M12 14h.01"></path><path d="M16 14h.01"></path><path d="M8 18h.01"></path><path d="M12 18h.01"></path><path d="M16 18h.01"></path></svg><span>Day 1 : 21st March</span></div><div class="flex items-center gap-1 md:gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock md:size-6"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg><span>Sat - 7PM to 9PM</span></div></div></div><div class="border border-black p-2 py-4 flex-1 flex justify-center items-center text-center"><div class="flex flex-row md:flex-row items-center gap-2 text-sm md:text-lg font-mackina"><div class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar-days md:size-6"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect width="18" height="18" x="3" y="4" rx="2"></rect><path d="M3 10h18"></path><path d="M8 14h.01"></path><path d="M12 14h.01"></path><path d="M16 14h.01"></path><path d="M8 18h.01"></path><path d="M12 18h.01"></path><path d="M16 18h.01"></path></svg><span>Day 2 : 22nd Mar</span></div><div class="flex items-center gap-1 md:gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock md:size-6"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg><span>Sun - 11AM to 1PM</span></div></div></div></div></div></section>
    ...
    <section>
        <section class="my-24 mb-32">
            <div class="w-[90%] md:w-4/5 mx-auto text-center">
                <div class="text-left mb-8"><h3 class="text-sm font-figtree font-medium text-neutral-600 uppercase">Curriculum</h3><h2 class="text-[24px] sm:text-[32px] font-medium font-mackinac">What You’ll Build in 2 Days?</h2> <p class="text-s text-neutral-700">No prior AI experience needed — just basic coding knowledge.</p> </div>
                ...
                <div class="border border-neutral-300  bg-white w-full md:w-[520px]" >
                    <div class="p-4">
                        <p class="text-sm text-neutral-600 my-2">Day 01 <span>•</span> 7 PM - 11 PM IST</p>
                        <h1 class="font-medium text-lg">Build Your First AI Chatbot (From Scratch)</h1>
                        <ul class="mt-2 list-disc ml- text-neutral-700">
                            <div class="flex items-center gap-4 mb-2"><img alt="" class="w-5 h-5 flex-shrink-0" src="{{asset('assets/img/genAiLP/gsl5.svg')}}"><span class="text-gray-700">Understand how GenAI actually works</span></div>
                            <div class="flex items-center gap-4 mb-2"><img alt="" class="w-5 h-5 flex-shrink-0" src="{{asset('assets/img/genAiLP/gsl7.svg')}}"><span class="text-gray-700">Write prompts that give real outputs</span></div>
                            <div class="flex items-center gap-4 mb-2"><img alt="" class="w-5 h-5 flex-shrink-0" src="{{asset('assets/img/genAiLP/gsl2.svg')}}"><span class="text-gray-700">Integrate OpenAI APIs into real-world usecases.</span></div>
                            <div class="flex items-center gap-4 mb-2"><img alt="" class="w-5 h-5 flex-shrink-0" src="{{asset('assets/img/genAiLP/gsl12.svg')}}"><span class="text-gray-700">Build your own chatbot</span></div>
                            <div class="flex items-center gap-4 mb-2"><img alt="" class="w-5 h-5 flex-shrink-0" src="{{asset('assets/img/genAiLP/gsl1.svg')}}"><span class="text-gray-700">Adding Knowledgebase to your Bot</span></div>
                ...
                <div class="border border-neutral-300 bg-white w-full md:w-[520px]">
                    <div class="p-4">
                        <p class="text-sm text-neutral-600 my-2">Day 02 <span>•</span> 11 AM - 1 PM IST</p>
                        <h1 class="font-medium text-lg">Build a Real AI Agent (Advanced)</h1>
                        <ul class="mt-2 list-disc 4 text-neutral-700">
                            <div class="flex items-center gap-4 mb-2"><img alt="" class="w-5 h-5 flex-shrink-0" src="{{asset('assets/img/genAiLP/gsl3.svg')}}"><span class="text-gray-700">Learn how AI systems take actions</span></div>
                            <div class="flex items-center gap-4 mb-2"><img alt="" class="w-5 h-5 flex-shrink-0" src="{{asset('assets/img/genAiLP/gsl10.svg')}}"><span class="text-gray-700">Make your AI agent take actions (not just respond)</span></div>
                            <div class="flex items-center gap-4 mb-2"><img alt="" class="w-5 h-5 flex-shrink-0" src="{{asset('assets/img/genAiLP/gsl11.svg')}}"><span class="text-gray-700">Build your own MCP Server</span></div>
                            <div class="flex items-center gap-4 mb-2"><img alt="" class="w-5 h-5 flex-shrink-0" src="{{asset('assets/img/genAiLP/gsl1.svg')}}"><span class="text-gray-700">Connecting your Agent with Claude</span></div>
                            <div class="flex items-center gap-4 mb-2"><img alt="" class="w-5 h-5 flex-shrink-0" src="{{asset('assets/img/genAiLP/gsl9.svg')}}"><span class="text-gray-700">Complete a project you can showcase or monetize</span></div>
                            
    
                            {{-- <li>Turn your chatbot into an autonomous AI agent</li>
                            <li>Learn how AI systems take actions</li>
