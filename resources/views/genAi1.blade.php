                    ...
                    <div class="relative w-full max-w-md mx-auto py-8">
                        <div class="relative text-center p-3 sm:p-6 ">
                            <div class="flex flex-col mb-6 space-y- text-center">
                                ...
                                <p class="text-sm text-red-600 -mt- font-medium">Live class from 15th Dec | 07:00 PM</p>
                            </div>
                            <form class="space-y-3 text-left  mt-10" action="https://codekaro.in/course-enrollment-auto" method="POST" id="enrollmentForm" @submit.prevent="validateAndSubmit">
                                ...
                                <input type="hidden" name="courseId" value="169">
                                <div class="space-y-1">
            ...
            <div class="w-[100%] md:w-4/5 mx-auto bg-cover bg-white bg-center bg-[url('/assets/img/genAiLP/ctherom.webp')] md:bg-[url('/assets/img/genAiLP/newhero.svg')] border md:border-[#041B014D] md:p-8">
                <div class="flex items-center justify-center md:mb-8 mb-4 pt-4">
                    ...
                    <div class="flex flex-col items-center text-center py-5">
                        ...
                        <h1 class="text-2xl md:text-[34px] font-medium mb-4 font-mackinac">Learn Gen AI in Just 2 Days by Building Your Own AI Agent Like ChatGPT</h1><p class="text-gray-700 text-14 md:text-[22px] w-[80%] mb-4 font-figtree font-normal">In <span class="font-semibold">just 2 days</span>, go from API Integration to Building Gen AI Agents. Boost your engineering skills with hands-on learning, whether you're a beginner or already working with Gen AI.</p>
                        <div class="text-black hidden bg-[#EEFE05 text-sm font-figtree font-normal mb-4 p-2 border border-[#07090166]">For Active Coders &amp; Working Professionals</div><div class="flex flex-wrap justify-center gap-6 text-sm mb-6 md:w-[90%] w-[100%]">
                            <section class="w-full py-2 px-4 text-center"><div class="max-w-5xl mx-auto"><div class="w-full flex items-center justify-center"></div><div class="flex flex-col md:flex-row gap-4 md:gap-3 justify-center w-full"><div class="border border-black p-2 py-4 flex-1 flex justify-center items-center text-center"><div class="flex flex-row md:flex-row items-center gap-2 text-sm md:text-lg font-mackina"><div class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar-days md:size-6"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect width="18" height="18" x="3" y="4" rx="2"></rect><path d="M3 10h18"></path><path d="M8 14h.01"></path><path d="M12 14h.01"></path><path d="M16 14h.01"></path><path d="M8 18h.01"></path><path d="M12 18h.01"></path><path d="M16 18h.01"></path></svg><span>Day 1: 10th Jan</span></div><div class="flex items-center gap-1 md:gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock md:size-6"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg><span>Sat - 7PM to 9PM IST</span></div></div></div><div class="border border-black p-2 py-4 flex-1 flex justify-center items-center text-center"><div class="flex flex-row md:flex-row items-center gap-2 text-sm md:text-lg font-mackina"><div class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar-days md:size-6"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect width="18" height="18" x="3" y="4" rx="2"></rect><path d="M3 10h18"></path><path d="M8 14h.01"></path><path d="M12 14h.01"></path><path d="M16 14h.01"></path><path d="M8 18h.01"></path><path d="M12 18h.01"></path><path d="M16 18h.01"></path></svg><span>Day 2: 11th Jan</span></div><div class="flex items-center gap-1 md:gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock md:size-6"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg><span>Sun - 11AM to 1PM IST</span></div></div></div></div></div></section>
    ...
    <section>
        <section class="my-24 mb-32">
            <div class="w-[90%] md:w-4/5 mx-auto text-center">
                <div class="text-left mb-8"><h3 class="text-sm font-figtree font-medium text-neutral-600 uppercase">Curriculum</h3><h2 class="text-[24px] sm:text-[32px] font-medium font-mackinac">What will you learn in 2 days?</h2></div>
                <div class="flex  text-left justify-center md:justify-start w-full flex-col md:flex-row items-center md:items-start  gap-4">
                <div class="border border-neutral-300  bg-white w-full md:w-[460px]" >
                    <div class="p-3">
                ...
                <div class="border border-neutral-300 bg-white w-full md:w-[460px]">
                    <div class="p-3">
                        ...
                        <h1 class="font-medium text-lg">MCPs Server & Agentic AI</h1>
                        <ul class="mt-2 list-disc ml-4 text-neutral-700">
