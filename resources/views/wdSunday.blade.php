            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 mx-auto " style="height: 100vh; display:flex; align-items: center">
                    ...
                    <main class="text-center">
                        ...
                        <h1 class="display- fw-bolder mt-5" style="font-size: calc(1.25rem + 2.1vw);">Want to master <span class="wd_highlight"> frontend dev?</span>Join 2 hours live Bootcamp</h1>
                ...
                <h4 class="fw-500 py-4"> <strong>Sunday, 16th October </strong>  | 11:00 AM IST</h3>
    ...
    <div class="container d-none">
        <div class="col-lg-12 mx-auto p-3 ">
            ...
            <main class="text-center mt-5 pt-lg-5">
                ...
                <h4 class="fw-500 py-4"> <strong>Thu, 13th August to 14th August </strong>  | 06:00 PM IST</h3>
...
{{-- test --}}
                ...
                <div class="col-md-4 d-n ">
                  <div class="card f-4 ">
                    <div class="p-2 text-center h-100">
                        <img src="{{asset('assets/img/CardTwo.webp')}}" class="project img-flui" height="172"  alt="">
                        
                        <p class="fs-6 px-4 ">Build a highly responsive frontend for Food ordering website.</p>
                    </div>
                  <div class="cd f-4-bottom p-3">
                    Project: Food Ordering Webpage
                  </div>
                </div>
                </div>
    ...
    <section>
        <div class="container">
            <div class="text-center">
                <h1 class=" mx-xl-8 mb-0 fw-600">Loved by 31000+ students</h1>
...
<div class="modal" id="enroll" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content rounded-5 shadow">
          ...
          <div class="modal-body p-4 pt-0 text-center mt-4">
            ...
            <form action="{{ route('workshop-enrollment-auto') }}" method="POST" class="">
                ...
                <input type="hidden" name="courseId" value="135">
  ...
  let birthday = "october 16, 2022 11:00:00",
