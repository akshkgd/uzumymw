...
<p style="font-size:16px">This is {!! strtok($teacher, ' ') !!}, Super Congratulations on registering for the <strong>‘{{$workshopName}}’</strong>. Your class will start from {{$nextClass}} (IST). </p>
...
<strong><p style="font-size:16px">Join the group ASAP to get all important links and updates related to the web development bootcamp: <a href="{{$workshopGroup}}">CLICK HERE</a> </p> </strong> 
<br><br>
