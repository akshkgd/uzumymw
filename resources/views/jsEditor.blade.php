...
<body class="bg-white text-black h-screen overflow-hidden flex flex-col font-sans">
  <div class="flex flex-col h-screen" id="container">
    ...
    <div class="flex flex-1 overflow-hidden">
      <!-- Code Editor -->
      <div id="editor" class="w-2/3 h-full"></div>

      <!-- Output -->
      <div class="w-1/3 h-full border-l overflow-hidden flex flex-col">
