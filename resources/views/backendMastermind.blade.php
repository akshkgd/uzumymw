...
<head>
    ...
    <title>Backend Mastermind — Build Servers with Node.js & MongoDB</title>

    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="Backend Mastermind — Build Servers with Node.js &amp; MongoDB">
    <meta property="og:description"
        content="2-day live backend bootcamp. Build your server with Express.js &amp; a Todoist clone with MongoDB &amp; Mongoose.">
    ...
    <meta name="twitter:title" content="Backend Mastermind — Build Servers with Node.js &amp; MongoDB">
...
<body class="" x-data="{ 
                    ...
                    <div class="relative w-full max-w-md mx-auto py-8">
                        <div class="relative text-center p-3 sm:p-6 ">
                            <div class="flex flex-col mb-6 space-y- text-center">
                                <h1 class="text-xl font-semibold tracking-tight font-sans flex gap-1 justify-center">Join Live Backend Mastermind</h1>
                                <p class="text-sm text-red-600 -mt- font-medium">From Sat 16th May @ 8:00 PM</p>
                            </div>
                            <form class="space-y-3 text-left  mt-10" action="https://codekaro.in/course-enrollment-auto" method="POST" id="enrollmentForm" @submit.prevent="validateAndSubmit">
                                ...
                                <input type="hidden" name="courseId" value="178">
                                <div class="space-y-1">
                                ...
                                <div class="flex flex-col-reverse sm:flex-row sm:justify-between sm:space-x-2">
                                    <button type="submit" class="text-center w-full md:w-auto bg-[#FAFF00] hover:bg-[#E5E500] text-black font-medium py-2 px-8 border border-black text-base sm:text-xl font-figtree">
                                        Join Backend Mastermind for just  <span x-text="vipUpgrade ? ' ₹398 ' : ' ₹99 '"></span>
                                    </button>
                                </div>
                            </form>
    ...
    <section>
        <div class="w-full bg-cover bg-center py-10 flex justify-center items-center" style="background-image: url(&quot;/assets/img/genAiLP/dot.png&quot;); background-size: cover; background-position: center center;">
            <div class="w-[100%] md:w-4/5 mx-auto bg-cover bg-white bg-center bg-[url('/assets/img/genAiLP/ctherom.webp')] md:bg-[url('/assets/img/genAiLP/newhero.svg')] border md:border-[#041B014D] md:p-8">
                <div class="flex items-center justify-center md:mb-8 mb-4 pt-4">
                    ...
                    <div class="flex flex-col items-center text-center py-5">
                        <div class="text-black bg-[#EEFE05 text-sm font-figtree font-normal mb-4 p-2 border border-[#07090166]">For Coders &amp; Aspiring Backend Developers</div>
                        <h1 class="text-2xl md:max-w-3xl md:text-[30px] font-medium mb-4 font-mackinac">Go From Zero to Backend Developer in 2 Days</h1><p class="text-gray-700 text-14 md:text-[20px] w-[80%] mb-4 font-figtree font-normal">No fluff. No theory.
You'll build a real server with Node Js and ship a full-stack Todoist clone using MongoDB, Mongoose &amp; MVC — in just 2 days.</p>
                        <div class="text-black hidden bg-[#EEFE05 text-sm font-figtree font-normal mb-4 p-2 border border-[#07090166]">For Active Coders &amp; Working Professionals</div><div class="flex flex-wrap justify-center gap-6 text-sm mb-6 md:w-[90%] w-[100%]">
                            <section class="w-full py-2 px-4 text-center"><div class="max-w-5xl mx-auto"><div class="w-full flex items-center justify-center"></div><div class="flex flex-col md:flex-row gap-4 md:gap-3 justify-center w-full"><div class="border border-black p-2 py-4 flex-1 flex justify-center items-center text-center"><div class="flex flex-row md:flex-row items-center gap-2 text-sm md:text-lg font-mackina"><div class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar-days md:size-6"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect width="18" height="18" x="3" y="4" rx="2"></rect><path d="M3 10h18"></path><path d="M8 14h.01"></path><path d="M12 14h.01"></path><path d="M16 14h.01"></path><path d="M8 18h.01"></path><path d="M12 18h.01"></path><path d="M16 18h.01"></path></svg><span>Day 1 : 16th May</span></div><div class="flex items-center gap-1 md:gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock md:size-6"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg><span>Sat - 8PM onwards</span></div></div></div><div class="border border-black p-2 py-4 flex-1 flex justify-center items-center text-center"><div class="flex flex-row md:flex-row items-center gap-2 text-sm md:text-lg font-mackina"><div class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar-days md:size-6"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect width="18" height="18" x="3" y="4" rx="2"></rect><path d="M3 10h18"></path><path d="M8 14h.01"></path><path d="M12 14h.01"></path><path d="M16 14h.01"></path><path d="M8 18h.01"></path><path d="M12 18h.01"></path><path d="M16 18h.01"></path></svg><span>Day 2 : 17th May</span></div><div class="flex items-center gap-1 md:gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock md:size-6"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg><span>Sun - 11AM onwards</span></div></div></div></div></div></section>
                                </div><div class="font-figtree font-medium mb-4 md:text-xl">Mentors</div><div class="w-full overflow-x-auto pb-4 md:pb-0"><div class="flex md:flex-wrap justify-center gap- md:gap-2 min-w-max md:min-w-0"><div class="flex flex-col items-center w-[150px] md:w-auto text-center"><img src="/assets/img/genAiLP/ash.jpeg" alt="Sidharth" class="w-20 h-20 md:w-24 md:h-24"><div class="mt-2"><p class="font-figtree font-medium">Ashish</p><p class="text-gray-600 text-sm font-figtree font-normal">EX: Lido, Co Founder</p><p class="text-gray-600 text-sm font-figtree font-normal">Codekaro</p></div></div><div class="flex flex-col items-center w-[150px] md:w-auto text-center"><img src="{{asset('assets/img/him.svg')}}" alt="Himanshu Srivastava" class="w-20 h-20 md:w-24 md:h-24"><div class="mt-2"><p class="font-figtree font-medium">Himanshu</p><p class="text-gray-600 text-sm font-figtree font-normal">Head of AI Initiatives</p><p class="text-gray-600 text-sm font-figtree font-normal">Codekaro</p></div></div><div class="flex hidden flex-col items-center w-[150px] md:w-auto text-center"><img src="/mdil.png" alt="KVS Dileep" class="w-20 h-20 md:w-24 md:h-24"><div class="mt-2"><p class="font-figtree font-medium">KVS Dileep</p><p class="text-gray-600 text-sm font-figtree font-normal">Head of AI Initiatives</p><p class="text-gray-600 text-sm font-figtree font-normal">codekaro</p></div></div></div></div>
    ...
    <section>
        <section class="my-24 mb-32 ">
            <div class="w-[90%] md:w-4/5 mx-auto text-center">
                    ...
                    <div class="border-t border-neutral-300 bg-cover bg-center bg-[#f9fee " style="background-image: url(&quot;/assets/img/genAiLP/back.svg&quot;);">
                        <div class="p-4 ">
                            ...
                            <div class="flex gap-4 items-center">
                                <span class="mt-2 text-sm font-semibold bg-gray-900 text-white px-2 py-1 rounded">Node.js</span>
                                <span class="mt-2 text-sm font-semibold bg-gray-900 text-white px-2 py-1 rounded">Express.js</span>
                                <span class="mt-2 text-sm font-semibold bg-gray-900 text-white px-2 py-1 rounded">Postman</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="border border-neutral-300 bg-white w-full md:w-[520px]">
                    <div class="p-4">
                        <p class="text-sm text-neutral-600 my-2">Day 02 <span>•</span> Sun 17th May — 11:00 AM IST</p>
                        <h1 class="font-medium text-lg">Build a Todoist Clone — MongoDB, Mongoose &amp; MVC</h1>
                        <ul class="mt-2 list-disc text-neutral-700">
                            <div class="flex items-center gap-4 mb-2"><img alt="" class="w-5 h-5 flex-shrink-0" src="{{asset('assets/img/genAiLP/gsl3.svg')}}"><span class="text-gray-700">Introduction to MongoDB &amp; NoSQL databases</span></div>
                            <div class="flex items-center gap-4 mb-2"><img alt="" class="w-5 h-5 flex-shrink-0" src="{{asset('assets/img/genAiLP/gsl10.svg')}}"><span class="text-gray-700">Connecting your Express app to MongoDB with Mongoose</span></div>
                            <div class="flex items-center gap-4 mb-2"><img alt="" class="w-5 h-5 flex-shrink-0" src="{{asset('assets/img/genAiLP/gsl11.svg')}}"><span class="text-gray-700">Defining Schemas &amp; Models with Mongoose</span></div>
                            <div class="flex items-center gap-4 mb-2"><img alt="" class="w-5 h-5 flex-shrink-0" src="{{asset('assets/img/genAiLP/gsl1.svg')}}"><span class="text-gray-700">Structuring code with MVC architecture</span></div>
                            <div class="flex items-center gap-4 mb-2"><img alt="" class="w-5 h-5 flex-shrink-0" src="{{asset('assets/img/genAiLP/gsl9.svg')}}"><span class="text-gray-700">Build full CRUD — Todoist Clone you can ship &amp; show</span></div>
                        </ul>
                    </div>
                    <div class="border-t border-neutral-300 bg-cover bg-center bg-[#f9fee " style="background-image: url(&quot;/assets/img/genAiLP/back.svg&quot;);">
                        <div class="p-4 ">
                ...
                <div class="border hidden border-neutral-300  bg-white w-full ">
                    <div class="p-3">
    ...
    <section class="my-24 mb-32">
            ...
            faqs: [
  {
    question: 'What will I build in this Backend Mastermind?',
    answer: 'Over 2 live sessions you will build two real projects: a working REST API server using Node.js & Express.js on Day 1, and a fully functional Todoist clone (CRUD app) using MongoDB, Mongoose, and an MVC folder structure on Day 2.'
  },
  {
    question: 'Do I need prior backend experience to join?',
    answer: 'No prior backend experience is required. You should have a basic understanding of JavaScript (variables, functions, arrays). We start from setting up Node.js and go all the way to a deployable project.'
  },
  {
    question: 'What are the session dates and timings?',
    answer: 'Day 1 is on Saturday, 16th May at 8:00 PM IST. Day 2 is on Sunday, 17th May at 11:00 AM IST. Both sessions are live and interactive.'
  },
  {
    question: 'What is Express.js and why are we learning it?',
    answer: 'Express.js is the most popular Node.js framework for building web servers and REST APIs. It is used by companies like Uber, Twitter, and IBM. Learning it gives you a solid foundation for any backend role.'
  },
  {
    question: 'What is MVC architecture and why does it matter?',
    answer: 'MVC stands for Model-View-Controller. It is a design pattern that keeps your code clean and organized. Every professional backend codebase follows this structure, and learning it early sets you apart from self-taught developers.'
  },
  {
    question: 'Why MongoDB instead of a SQL database?',
    answer: 'MongoDB is a NoSQL database that is extremely popular for JavaScript-based backends (the MERN stack). It pairs naturally with Node.js and Mongoose makes interacting with it simple and powerful. You will also understand when to choose SQL vs NoSQL after this session.'
  },
  {
    question: 'What tools or software do I need before the session?',
    answer: 'You need a laptop with Node.js and npm installed, a code editor (VS Code is recommended), and Postman or Thunder Client for testing APIs. All installation steps will be shared before the session — everything is free.'
  },
  {
    question: 'How will the live sessions be conducted?',
    answer: 'Sessions are conducted live via a streaming link shared on WhatsApp. The mentor will code live, explain concepts in real time, and you can ask questions throughout. Everything is hands-on — no slide decks, just real code.'
  },
  {
    question: 'What if I miss a live session?',
    answer: 'Session recordings are available exclusively to VIP members. If you are a VIP member, you will receive access to all recordings within 24 hours after each session is completed.'
  },
  {
    question: 'What do I get with VIP membership?',
    answer: 'VIP membership gives you lifetime access to session recordings, bonus backend projects, code repositories, and additional resources to keep learning after the 2 days are over.'
  },
  {
    question: 'Will I get a certificate after completing the bootcamp?',
    answer: 'Yes, a verified completion certificate is issued after you attend the live sessions and complete the final project. It can be downloaded from your student dashboard and added to your LinkedIn profile.'
  },
  {
    question: 'Can a complete beginner with only HTML/CSS knowledge join?',
    answer: 'If you know only HTML/CSS but no JavaScript yet, this session may be challenging. We recommend having at least basic JavaScript knowledge (variables, functions, loops). If you are comfortable with JS fundamentals, you are ready.'
  },
  {
    question: 'Will the code and project be shared after the session?',
    answer: 'Yes, the complete code written during both sessions will be shared with all registered participants via the WhatsApp group.'
  },
  {
    question: 'I paid the enrollment fee but did not receive a confirmation email.',
    answer: 'Please wait 5–10 minutes for the email to arrive. Check your spam or promotions folder as well. Search for an email from Codekaro in your inbox. If you still have not received it, reach out to us on WhatsApp.'
  },
  {
    question: 'Can I get a refund after enrolling?',
    answer: 'Refunds are governed by our Terms & Conditions and Refund Policy. Given the low enrollment fee and the live nature of the sessions, refunds are generally not applicable. Please read our policy before enrolling.'
  },
  {
    question: 'How can I refer a friend to this bootcamp?',
    answer: 'You can share this page directly with friends. The more people who join, the more interactive the session becomes — so spread the word!'
  }
            ]
        }">
                    <!-- Dynamic FAQ Items -->
