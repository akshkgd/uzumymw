...
<body>
    ...
    <div class="m-cta text-light">
        <div class="">
            <p class="m-0 fw-bold text-light"> ₹149 <span class="small text-white fw-light"
            ...
            <div class="modal-content rounded-5 shadow">
                ...
                <div class="modal-body p-4 pt-0 text-center mt-4">
                    ...
                    <form action="{{ route('course-enrollment-auto') }}" method="POST" class="">
                        ...
                        <input type="hidden" name="courseId" value="{{$batch->id}}">
    ...
    <script>
        function toggleRecordingCheckbox(checkboxItem) {
            ...
            if (checkbox.value === "0") {
                ...
                priceElement.innerText = "348";

            } else {
                checkbox.value = "0";
                checkboxItem.classList.remove("checked");
                priceElement.innerText = "149";
