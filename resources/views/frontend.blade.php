...
<head>
    ...
    <!-- Primary Meta Tags -->
<title>Land a 6-8 LPA Frontend Job in 45 Days | Cohort for Freshers @ ₹29,999</title>
...
<meta property="og:description" content="Guaranteed frontend job or 100% refund. Join freshers cohort at ₹29,999. Live mentorship, mock interviews, and limited slots!">
...
<meta property="twitter:description" content="Crack interviews with live Zoom sessions, 3 real projects, and placement support. Enroll now @ ₹29,999!">
...
<body class="bg-neutral-950 select-non">
    ...
    <section class="h-screen flex items-center justify-center text-center md:p-0 p-5">
        ...
        <div class="max-w-6xl l-16 text-center">
            ...
            <!-- stats -->
            <p class="text-neutral-500 sm:px-5 text-2xl sm:text-2xl mt-8 text-center">45-Day Cohort for Freshers @ ₹29,999</p>
             ...
             <div class="flex flex-col md:flex-row justify-center gap-4 mt-">
                ...
                <div class="inline-block  bg-neutral-800 py-2 px-4 sm:text-2xl text-xl font-medium text-neutral-200 rounded-lg ring-4 ring-neutral-800">45 days Cohort</div>
                <div class="inline-block  bg-neutral-800 py-2 px-4 sm:text-2xl text-xl font-medium text-neutral-200 rounded-lg ring-4 ring-neutral-800">Only Rs 5700/-</div> -->
            
             </div>
             <img src="../fr-placed.svg" alt="" class="inline-block w-96 mt-5 text-center">
             <!-- <a href="" class="inline-block py-2 w-full bg-green-600">Join now & Dominate Frontend</a> -->
        </div>
    </section>


    <section class="my-24 flex items-center justify-center md:p-0 p-5 ">
        
        <div class="sm:w-8/12 max-w-5xl mx-auto sm:bg-neutral-900 text-left sm:text-center rounded-2xl p-10 l-16 ">
            
                <h1 class="text-white 2xl:text-6xl sm:text-4xl text-4xl font-black">100 percent <span class="key-highlight text-whit bg-gradient-to-r from-green-600 to-green-500 bg-clip-text text-transparent">Money Back Guarantee <img class="absolute bottom-0 left-0" src="../green-highlight.sv" alt=""> </span></h1>
            
            <div class=" mx-auto ">
            
            <div class="py-5 text-left mt-8">
                <p class="text-neutral-600 text-xl sm:text-2xl mt-4 ">Terms & Conditions</p>
               <ul>
                <li class="text-white text-xl">1. You have to watch one video from start-to-end every day.</li>
                <li class="text-white text-xl">2. You have to complete your assignments and submit by end of the day.</li>
                <li class="text-white text-xl">3. There will be no refunds after 45 days of enrollment.</li>
               </ul>
            </div>
            </div>
    ...
    <section class=" flex items-center justify-center md:p-0 p-5 ">
        
        <div class="sm:w-8/12 max-w-5xl mx-auto sm:bg-neutral-900 text-left sm:text-center rounded-2xl p-10 l-16 ">
            
                <h1 class="text-white 2xl:text-6xl sm:text-4xl text-4xl font-black">Cohort <span class="key-highlight text-whit bg-gradient-to-r from-green-600 to-green-500 bg-clip-text text-transparent">Structure<img class="absolute bottom-0 left-0" src="../green-highlight.sv" alt=""> </span></h1>
            
            <div class=" mx-auto ">
            
            <div class="py-5 text-left mt-8">
               <ul>
                <li class="text-white text-xl">1. Cohort Duration: 45 Days</li>
                <li class="text-white text-xl">2. Everyday New Video at 6:00 pm </li>
                <li class="text-white text-xl">3. Weekly Live Doubt Solving Sessions: Saturday  6:00 - 7:00 pm</li>
                <li class="text-white text-xl">5. Batch Size: 25 - 50 Learners</li>
                <li class="text-white text-xl">5. No B.S. </li>
    ...
    <!-- second section -->
     <!-- <section class="h-screen 2xl:max-w-7xl max-w-5xl mx-auto  flex items-center">
        <div class="mb-32 l-16 text-center p-5">
            <h1 class="text-white sm:block hidden font-black  2xl:text-6xl sm:text-5xl text-4xl">We believe in,<br><span class="key-highlight text-whit bg-gradient-to-r from-green-600 to-green-500 bg-clip-text text-transparent">Consistency. </span>No shortcuts.</h1>
            <h1 class="text-white block sm:hidden font-black  2xl:text-6xl sm:text-5xl text-4xl">We believe in, <span class="key-highlight text-whit bg-gradient-to-r from-green-600 to-green-500 bg-clip-text text-transparent">Consistency. </span>No shortcuts.</h1>
    ...
    <section class="s:h-screen h-[60vh] mt-24 2xl:max-w-4xl max-w-3xl mx-auto  flex items-center">
        <div class="text-center">
          <h1 class="text-white block sm:hidden font-black  2xl:text-6xl sm:text-5xl text-4xl mb-12">Meet <span class="relative"> your Mentor 
          ...
          <h1 class="text-white hidden sm:block font-black  2xl:text-5xl sm:text-5xl text-4xl mb-12">Meet  your <span class="relative"> Mentor 
            <svg xmlns="http://www.w3.org/2000/svg" width="179" height="5" viewBox="0 0 179 5" class="absolute left-0 bottom-0">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M122.746 0.713854C122.784 0.651055 122.805 0.580758 122.805 0.506545C122.805 0.24028 122.533 0.0244304 122.199 0.0244304C114.148 0.0244304 106.097 0.0189871 98.046 0.0135436C81.9421 0.00265576 65.8369 -0.00823294 49.733 0.0244319C48.4525 0.0270293 47.1582 0.0198336 45.8554 0.0125912C41.247 -0.0130289 36.5334 -0.0392343 31.9531 0.365425C31.6031 0.396348 31.3287 0.425727 31.1286 0.454213C31.0297 0.468307 30.9371 0.483818 30.8576 0.501726C30.8179 0.510657 30.7718 0.522336 30.7251 0.537838C30.6866 0.55063 30.6077 0.578775 30.5297 0.631331C30.4613 0.677479 30.271 0.829221 30.3097 1.0745C30.3446 1.29584 30.5419 1.40547 30.5945 1.43279C30.7165 1.49624 30.8526 1.51936 30.9023 1.52781L30.9036 1.52803C31.0473 1.55244 31.2454 1.56952 31.465 1.58318C32.3605 1.63888 34.1193 1.6652 36.1961 1.67654C38.848 1.69101 42.07 1.68104 44.7749 1.67268C46.3164 1.66791 47.69 1.66366 48.6944 1.66475C61.4136 1.67857 74.1329 1.68394 86.8522 1.68474C75.4613 1.90893 64.0711 2.18306 52.6849 2.53537C39.5301 2.58451 27.1174 2.63048 16.9987 2.66796C10.4229 2.69232 4.8159 2.71309 0.603492 2.7288C0.268625 2.73005 -0.00156443 2.94691 6.81838e-06 3.21317C0.00157802 3.47943 0.274315 3.69427 0.609182 3.69302C4.82149 3.67731 10.4284 3.65654 17.0041 3.63218C19.2244 3.62396 21.555 3.61532 23.9797 3.60634C23.5149 3.62692 23.0501 3.64766 22.5853 3.66858C18.6225 3.84694 16.5993 3.94898 15.8861 3.99926C15.796 4.00561 15.7215 4.01149 15.6642 4.01699C15.6359 4.0197 15.6068 4.02279 15.5796 4.02639L15.5778 4.02663C15.562 4.02869 15.5038 4.03629 15.4426 4.05394C15.4238 4.05937 15.3853 4.07113 15.3408 4.09176C15.313 4.10463 15.1946 4.15949 15.1133 4.27692C15.0786 4.33624 15.0396 4.47447 15.0403 4.55126C15.0556 4.62541 15.1196 4.75165 15.1625 4.80279C15.2571 4.9014 15.3723 4.94207 15.4004 4.95199C15.4734 4.97776 15.5381 4.98631 15.5526 4.98823L15.5539 4.98841C15.5787 4.99174 15.6004 4.99353 15.6144 4.99455C15.6653 4.99824 15.7279 4.99931 15.7838 4.99975C16.0219 5.00162 16.5054 4.99307 17.1392 4.97815C18.8956 4.9368 21.9153 4.8436 24.5065 4.76362C25.678 4.72747 26.762 4.69401 27.602 4.66927C51.8201 3.95607 76.061 3.5554 100.303 3.3193C115.375 3.26113 128.889 3.20746 138.263 3.16717C151.341 3.11096 158.303 3.07459 161.315 3.05196C162.068 3.04631 162.576 3.0415 162.871 3.03743C163.015 3.03544 163.118 3.03353 163.172 3.03148C163.185 3.03103 163.206 3.03018 163.227 3.02848L163.228 3.02845C163.233 3.02808 163.271 3.0253 163.315 3.01691C163.353 3.00864 163.494 2.95721 163.587 2.90067C163.771 2.63333 163.599 2.20376 163.436 2.1127C163.385 2.09544 163.308 2.07739 163.284 2.07345C163.271 2.07155 163.249 2.06898 163.24 2.0681C163.223 2.06654 163.209 2.06575 163.201 2.06537C163.185 2.06454 163.168 2.06401 163.153 2.06363C162.942 2.0581 162.012 2.05564 160.659 2.05502C155.214 2.05253 142.642 2.08057 140.288 2.09027C129.441 2.13496 118.59 2.19632 107.739 2.2876C113.633 2.19772 119.527 2.11658 125.421 2.04029C140.287 1.84786 148.18 1.77648 162.686 1.7023C166.085 1.68492 169.484 1.67719 172.884 1.66945C173.562 1.66791 174.24 1.66637 174.918 1.66475H178.413C178.557 1.66475 178.632 1.66471 178.649 1.66463L178.656 1.66457C178.656 1.66457 178.662 1.66451 178.668 1.66431C178.674 1.66413 178.696 1.66301 178.713 1.66173C179.149 1.45313 179.039 0.814696 178.71 0.703016C178.695 0.701884 178.674 0.700861 178.669 0.70069L178.66 0.700489L178.654 0.700403L178.648 0.700362L178.624 0.700285L178.523 0.700131C178.34 0.699914 177.976 0.699653 177.539 0.699479C176.666 0.699131 175.5 0.69913 174.916 0.700522H173.594C159.716 0.700522 145.838 0.705547 131.96 0.710572C128.889 0.711684 125.818 0.712796 122.746 0.713854ZM15.7811 4.97724C15.7741 4.97832 15.7726 4.97834 15.7786 4.97755C15.779 4.97749 15.7798 4.97739 15.7811 4.97724ZM31.1386 0.581393C31.1389 0.58132 31.1431 0.582083 31.1503 0.583901C31.1419 0.582375 31.1383 0.581466 31.1386 0.581393Z" style="fill: #22c55e"/>
          </svg></span> </h1>
            <div class="fle gap-6 items-center">
                <img class="inline-block sm:h-52 sm:w-52 h-36 w-36  object-cover sm:rounded-xl rounded-full" lazy src="https://codekaro.in/assets/img/ashish.jpeg" alt="">
      ...
      <!-- feedbacks -->
    <div class="max-w-4xl mx-auto mt-32 mb-12 hidde">
        <div class="text-center my-10">
            <h1 class="text-4xl font-extrabold font-manrop text-white">Hear from our students</h1>
            <p class="text-lg text-neutral-500">Find out what our students have to say about us</p>
        </div>
        <div class="columns-1 sm:columns-2 lg:columns-3 gap-6 space-y-6">
            <div class="break-inside-avoid  feedback-card bg-white borde rounded-3xl">
                <!-- <div style="position:relative;padding-top:56.25%;"><iframe src="https://iframe.mediadelivery.net/embed/386364/c5ef7646-20f4-4fdd-ab38-09ad9c36821a?autoplay=true&loop=false&muted=false&preload=true&responsive=true" loading="lazy" style="border:0;position:absolute;top:0;height:100%;width:100%;" allow="accelerometer;gyroscope;autoplay;encrypted-media;picture-in-picture;" allowfullscreen="true"></iframe></div> -->
                <!-- <video class="rounded-3xl" controls muted autoplay loop src="https://iframe.mediadelivery.net/play/386364/c5ef7646-20f4-4fdd-ab38-09ad9c36821a"></video> -->
            </div>
            <!-- Feedback 1 -->
            ...
            <div class="break-inside-avoid  p-3 feedback-card bg-neutral-90 text-white borde rounded-3xl">
                <div class="flex mb-3 justify-content-between align-items-center">
                    <img src="{{asset('assets/img/feedbacks/prashanthFeedback.jpeg')}}" class="rounded-2xl" alt="">
                </div>
            </div>
    
            <!-- Feedback 2 -->
            <div class="break-inside-avoid p-3 feedback-card bg-whit borde rounded-3xl">
                <img src="{{asset('assets/img/feedbacks/priyaFeedback.jpeg')}}" class="rounded-2xl" alt="">
            ...
            <!-- Feedback 6 -->
            <div class="break-inside-avoid p-3 feedback-card bg-whi borde rounded-3xl">
                <img src="{{asset('assets/img/feedbacks/princeFeedback.jpeg')}}" alt="" class="rounded-2xl">    
            </div>
            <div class="break-inside-avoid p-3 feedback-card bg-whi borde rounded-3xl">
                <img src="{{asset('assets/img/feedbacks/suyashFeedback.jpeg')}}" alt="" class="rounded-2xl">    
            </div>

            
            
            <div class="break-inside-avoid p-3 feedback-card bg-whi borde rounded-3xl">
                <img src="{{asset('assets/img/feedbacks/gauravPatilFeedback.jpeg')}}" alt="" class="rounded-2xl">    
            </div>
    ...
    <!-- feedback ends -->
     <section class="lg:h-screen flex items-center">
        <div class="max-w-5xl mx-auto p-5 mt-48 mb-24 text-cente">
            <h1 class="hidden sm:block text-white 2xl:text-6xl sm:text-5xl text-4xl font-black">Invest ₹29,999 today → Earn 6-8 LPA package in next 45 days!</h1>
            <h1 class="sm:hidden text-white lg:text-9xl sm:text-7xl text-4xl text-center  font-bold">Invest ₹29,999 today → Earn 6-8 LPA in 45 days!</h1>
      ...
      if (videoSrc) {
        if (Hls.isSupported()) {
          ...
          video.src = videoSrc;
            ...
            <a href="https://codekaro.in/enroll/120" class="inline-block text-white bg-gradient-to-r from-green-600 to-green-500 bg-clip-tex mt-3 mb-12 sm:px-12 w-full sm:w-auto text-center py-4 sm:rounded-xl rounded-full sm:text-3xl text-xl font-bold shado shado-xl shadow-neutral-500">Join frontend cohort now at 29,999/-</a>
        </div>
     </section>
