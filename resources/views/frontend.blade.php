...
<html lang="en">
  <head>
    ...
    <title>Frontend Cohort</title>
    <meta name="keywords" content="Frontend Cohort">
    <meta name="og:description" content="Welcome to the Complete Web Development Bootcamp, the only course you need to learn to code and become a frontend developer.">
    <link rel="canonical" href="https://codekaro.in/frontend-cohort"/>
...
<!-- navbar ends -->
    ...
    <section>
        <div class="container pt-0 pt-lg-5 pt-xlg-5 pt-md-5 mt-5 ">
            <div class="row">
                <div class="col-md-8">
                    <h1 class="fw-bold fs-2 m-0">Frontend Cohort</h1>
                    <p class="mt-2 fs-6">Welcome to the frontend cohort, learn what matters and become a frontend web developer.</p>


                    <div>
                        <div class="car card-bod">
                            <div class="badge fs-6 badge-pill badge-primary bg-mute text-dark fw-normal" style="border-radius: 40px;">Starting on 3rd August</div>
                            <div class="badge fs-6 badge-pill badge-primary bg-mute text-dark fw-normal" style="border-radius: 40px;">Evening classes 8:00 PM</div>
                    ...
                    <div class="accordion my-5" id="accordionExample">
                                ...
                                <div id="collapse88"
                                    ...
                                    <div class="accordion-body">
                                        <p class="mb-2 pl-2 " style="font-size:17px;">
                                              <br /><i class='bi bi-dot fs-4'></i>What is Tailwind?   <br /><i class='bi bi-dot fs-4'></i>Installing Tailwind css   <br /><i class='bi bi-dot fs-4'></i>Web Design 101 - Wireframing   <br /><i class='bi bi-dot fs-4'></i>Tailwind Utilities   <br /><i class='bi bi-dot fs-4'></i>Installation from npm   <br /><i class='bi bi-dot fs-4'></i>Setting Up Our New Project   <br /><i class='bi bi-dot fs-4'></i>Tailwind grid layout   <br /><i class='bi bi-dot fs-4'></i>Customizing Tailwind css  <br /><i class='bi bi-dot fs-4'></i>Adding Grid Layouts to Our Website   <br /><i class='bi bi-dot fs-4'></i>A Note About CSS Link Order   <br /><i class='bi bi-dot fs-4'></i><i class='bi bi-dot fs-4'></i>Tailwind Positions  <br /><i class='bi bi-dot fs-4'></i>Project: Todo app frontend   <br /><i class='bi bi-dot fs-4'></i>
                                        </p>
                                ...
                                <div id="collapse89"
                                    ...
                                    <div class="accordion-body">
                                        <p class="mb-2 pl-2 " style="font-size:17px;">
                                              <br /><i class='bi bi-dot fs-4'></i>The responsive designs   <br /><i class='bi bi-dot fs-4'></i>Mobile friendly Designs   <br /><i class='bi bi-dot fs-4'></i>ChatGPT Clone (Responsive)   <br /><i class='bi bi-dot fs-4'></i>Challenge 2 Netflix Clone   <br /><i class='bi bi-dot fs-4'></i>Code Refactoring Put it into Practice   <br /><i class='bi bi-dot fs-4'></i>Get production ready  <br /><i class='bi bi-dot fs-4'></i>Advanced CSS - Selector Priority Project : Completing the Website
                                        </p>
                                ...
                                <div id="collapse92"
                                    ...
                                    <div class="accordion-body">
                                        <p class="mb-2 pl-2 " style="font-size:17px;">
                                              <br /><i class='bi bi-dot fs-4'></i>Conditionals - Truthy and Falsy  <br /><i class='bi bi-dot fs-4'></i>Loos   <br /><i class='bi bi-dot fs-4'></i>Functions and Arrow functions   <br /><i class='bi bi-dot fs-4'></i>Array mapping & Filters    <br /><i class='bi bi-dot fs-4'></i>Sync and Async Javascript   <br /><i class='bi bi-dot fs-4'></i>Event loops <br /><i class='bi bi-dot fs-4'></i>Async Await & Promises  <br /><i class='bi bi-dot fs-4'></i>Search Movie App (API)  <br /><i class='bi bi-dot fs-4'></i>User Management System   <br /><i class='bi bi-dot fs-4'></i>Local storage & Sessions
                                        </p>
                                ...
                                <div id="collapse94"
                                    ...
                                    <div class="accordion-body">
                                        <p class="mb-2 pl-2 " style="font-size:17px;">
                                            Major Project creating the seat booking feature
                                        </p>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapse104"
                                    ...
                                    <div class="accordion-body">
                                        <p class="mb-2 pl-2 " style="font-size:17px;">
                                              <br /><i class='bi bi-dot fs-4'></i>Learn front-end development with React.   <br /><i class='bi bi-dot fs-4'></i>React Components.   <br /><i class='bi bi-dot fs-4'></i>Props and props drilling   <br /><i class='bi bi-dot fs-4'></i>Learn to write JSX.   <br /><i class='bi bi-dot fs-4'></i>React Events.   <br /><i class='bi bi-dot fs-4'></i>Learn State Management in React.   <br /><i class='bi bi-dot fs-4'></i>UseState Hook.   <br /><i class='bi bi-dot fs-4'></i>UseEffect Hook and API   <br/><i class='bi bi-dot fs-4'></i>React UseRef and Forms <br><i class='bi bi-dot fs-4'></i>Axios <br><i class='bi bi-dot fs-4'></i>Context API <br> <i class='bi bi-dot fs-4'></i>Redux Toolkit <br> <i class='bi bi-dot fs-4'></i>Authentication using Clerk
                                        </p>
                                ...
                                <div id="collapse105"
                                    ...
                                    <div class="accordion-body">
                                        <p class="mb-2 pl-2 " style="font-size:17px;">
                                              ...
                                              <i class='bi bi-dot fs-4'></i>Instagram Clone <br>
                                              <i class='bi bi-dot fs-4'></i>Image generation using DALLE 3 <br>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapse102"
                                    ...
                                    <div class="accordion-body">
                                        <p class="mb-2 pl-2 " style="font-size:17px;">
                                              <br /><i class='bi bi-dot fs-4'></i>Understand hosting and deployment.   <br /><i class='bi bi-dot fs-4'></i>Hosting static websites with GitHub Pages.    <br /><i class='bi bi-dot fs-4'></i>Deploying in  vercel.    <br /><i class='bi bi-dot fs-4'></i>Linking Domain name  <br /><i class='bi bi-dot fs-4'></i>
                                        </p>
                ...
                <div class="col-md-4 mb-5 mb-lg-0 mb-xlg-0 mt-0">

                    <div class="card card-primary sticky-lg-top border-none shadow-lg" style="padding: 10px">
                        <img src="{{asset('assets/img/react.webp')}}" alt="Image"
                        ...
                        <div class="bg-primary-al rounded-lg">
                            <div class="mt-2">
                                <h1 class="fs-5 mt-3 text-dark text-cente mb-0">Frontend Cohort</h3>
                                    <p style="font-size: 14px; color:rgb(55, 55, 55)">Includes one year access to current and future updates to the course.</p>
                                    <div class="d-flex fs-4 justify-content-cente d-none">
                                        <span class="fs-6  mr-1 js-dollar-sign text-dark ck-font">Rs</span>
                                        <span class="fs-6 mr-2 js-price-per-month text-muted px-2"
                                            style="text-decoration:line-through; font-weight:400">48999</span>
                                        <span
                                            class="display- px-1 fs-6  js-price-per-month fw-400">14999/-</span>
                                    </div>

                                    

                                    <p class="ck-font fw-400  m-0 d-non">Starts From
                                        Sat, 03rd Aug</p>
