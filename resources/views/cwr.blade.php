    ...
    <div class="container ">
        <div class="col-lg-12 mx-auto p-3 ">
            ...
            <main class="text-center mt-5 pt-lg-5">
                <h1 class="display-5 fw-bolder">Get started with  <span class="wd_highlight">Live CSS masterclass</span> <br> for free with CWR</h1>
                ...
                <h4 class="fw-500 py-4"> <strong>16th June </strong>  | 04:00 PM IST</h3>

                    <div class="my-5">
                        <a href="https://codekaro.in/workshop-enroll/106" class="btn btn-dark btn-lg btn-block px-5">
...
{{-- test --}}
                ...
                <div class="col-md-4">
                  <div class="card f-1 ">
                    ...
                    <div class="cd f-1-bottom p-3">
                        <strong>Project:</strong> Food ordering webpage
                    </div>
                  </div>
                </div>
  ...
  let birthday = "june 16, 2022 18:00:00",
