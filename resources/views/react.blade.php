...
@section('meta_description',
    ...
    <style>
        .underline{
            text-decoration: underline #efa30e;;
        }
        .recording-container {
...
@section('content')
            ...
            <div class="row justify-content-center align-items-cente">
                <div class="col-md-8">
                    <main class="text-center">
                        <img class="react-logo"  src="{{asset('assets/img/logo.svg')}}" alt="">
                        <h1 class="display-6 fw-bod  " style="line-height:1.5; color:aliceblue; font-weight:600">Master the concepts of React js <span></span> <span
                ...
                <div class="col-lg-5 mt-5 order-1 order-lg-2">
                    <div class="bg-dark p-2" style="background-color: #333333 !important">
                        <script src="https://fast.wistia.com/embed/medias/pmuygdjbt4.jsonp" async></script><script src="https://fast.wistia.com/assets/external/E-v1.js" async></script><div class="wistia_responsive_padding" style="padding:66.67% 0 0 0;position:relative;"><div class="wistia_responsive_wrapper" style="height:100%;left:0;position:absolute;top:0;width:100%;"><div class="wistia_embed wistia_async_pmuygdjbt4 seo=true videoFoam=true" style="height:100%;position:relative;width:100%"><div class="wistia_swatch" style="height:100%;left:0;opacity:0;overflow:hidden;position:absolute;top:0;transition:opacity 200ms;width:100%;"><img src="https://fast.wistia.com/embed/medias/pmuygdjbt4/swatch" style="filter:blur(5px);height:100%;object-fit:contain;width:100%;" alt="" aria-hidden="true" onload="this.parentNode.style.opacity=1;" /></div></div></div></div>
                        </div>
                    </div>
                ...
                <div class="col-lg-10 order-3 l-cta">
                    <div class="mb-5 white">
                        <a href="" style="width:100% !important"
                            ...
                            <h2 class="fs-3 mb-1 text-white fw-bold">Kickstart your webdev journey for just ₹297! </h2>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-4">
                    <div class="card h-100 mt-3 border-none ck-rounded f-3 px-5 py-3 my-3 text-center">
                        ...
                        <p>Build a complex ui of food ordering App clone of swiggy using API</p>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 mb-5">
                    <div class="shadow-card mt-5">
                        ...
                        <h3 class="fs-3 fw-bold">Introduction to React</h2>
                            <div class="mt-3"> <img height="10" class="me-3"
                                    src="{{ asset('assets/img/arrow2.svg') }}" alt=""> How to install react</div>
                            <div class="mt-3"> <img height="10" class="me-3"
                                    src="{{ asset('assets/img/arrow2.svg') }}" alt=""> JSX and react DOM</div>
                            <div class="mt-3"> <img height="10" class="me-3"
                                    src="{{ asset('assets/img/arrow2.svg') }}" alt=""> Props and components</div>
                            <div class="mt-3"> <img height="10" class="me-3"
                                    src="{{ asset('assets/img/arrow2.svg') }}" alt=""> Conditional Rendering</div>
                    </div>

                    <div class="shadow-card mt-5">
                        <div class="day">Day 2</div>
                        <h3 class="fs-3 fw-bold">Learn use of Hooks</h2>
                            <div class="mt-3"> <img height="10" class="me-3"
                                    src="{{ asset('assets/img/arrow2.svg') }}" alt=""> Learn UseState &amp;
                                Usecases</div>
                            <div class="mt-3"> <img height="10" class="me-3"
                                    src="{{ asset('assets/img/arrow2.svg') }}" alt="">How to update state</div>
                            <div class="mt-3"> <img height="10" class="me-3"
                                    src="{{ asset('assets/img/arrow2.svg') }}" alt=""> Creating Todo App</div>

                    </div>

                    <div class="shadow-card mt-5">
                        <div class="day">Day 3</div>
                        <h3 class="fs-3 fw-bold">Understand How API's Work?</h2>
                            <div class="mt-3"> <img height="10" class="me-3"
                                    src="{{ asset('assets/img/arrow2.svg') }}" alt="">Understand UseEffect</div>
                            <div class="mt-3"> <img height="10" class="me-3"
                                    src="{{ asset('assets/img/arrow2.svg') }}" alt="">Rendering data using API</div>
                            <div class="mt-3"> <img height="10" class="me-3"
                                    src="{{ asset('assets/img/arrow2.svg') }}" alt="">Creating swiggy clone</div>
                    </div>
    ...
    <div class="m-cta text-light">
        <div class="">
            <p class="m-0 fw-bold text-light">₹297 <span class="small text-white fw-light"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content rounded-5 shadow">
                ...
                <div class="modal-body p-4 pt-0 text-center mt-4">
                    ...
                    <h2 class=" mb-0 fs-3 fw-bold">Join 3 days live React bootcamp!</h2>
                    ...
                    <form action="{{ route('course-enrollment-auto') }}" method="POST" class="">
                        ...
                        <input type="hidden" name="courseId" value="49">
    ...
    <script>
        function toggleRecordingCheckbox(checkboxItem) {
            ...
            if (checkbox.value === "0") {
                ...
                priceElement.innerText = "496";

            } else {
                checkbox.value = "0";
                checkboxItem.classList.remove("checked");
                priceElement.innerText = "297";
