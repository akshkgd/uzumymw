"object" == typeof navigator && function(e, t) {
    ...
    var Be = Object.create || function(e, t) {
            var n;
            return null !== e ? (Fe.prototype = P(e), n = new Fe, Fe.prototype = null, n[De] = e) : n = He(), void 0 === t ? n : _e(n, t)
        },
        Ve = ye.f,
        ze = {}.toString,
    ...
    if (Le || (ee((gt = function() {
        ...
        Ie({
            ...
            stringify: function(e, t, n) {
                ...
                if (i = t, (g(t) || void 0 !== e) && !Lt(e)) return Ne(t) || (t = function(e, t) {
    ...
    var kn = {
        ...
        In = function(e, t, n, i, r, a, o) {
            ...
            if (g && (s = yn(g.call(new e)), Pn !== Object.prototype && s.next && (yn(s) !== Pn && (An ? An(s, Pn) : "function" != typeof s[Cn] && O(s, Cn, On)), nt(s, h, !0))), "values" == r && p && "values" !== p.name && (f = !0, m = function() {
                    return p.call(this)
                }), d[Cn] !== m && O(d, Cn, m), pn[t] = m, r)
                if (l = {
                        values: u("values"),
                        keys: a ? m : u("keys"),
                        entries: u("entries")
    ...
    Oi("split", 2, (function(e, t, n) {
        ...
        return i = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(e, n) {
            ...
            for (var a, o, s, l = [], c = (e.ignoreCase ? "i" : "") + (e.multiline ? "m" : "") + (e.unicode ? "u" : "") + (e.sticky ? "y" : ""), u = 0, h = new RegExp(e.source, c + "g");
                (a = di.call(h, i)) && !((o = h.lastIndex) > u && (l.push(i.slice(u, a.index)), a.length > 1 && a.index < i.length && Vi.apply(l, a.slice(1)), s = a[0].length, u = o, l.length >= r));) h.lastIndex === a.index && h.lastIndex++;
    ...
    var ir = Xe("iterator"),
        ...
        lr = !or || r((function() {
            ...
            for (var n = Re(e), i = arguments.length, r = 1, o = be.f, s = l.f; i > r;)
                for (var c, u = d(arguments[r++]), h = o ? Me(u).concat(o(u)) : Me(u), f = h.length, p = 0; f > p;) c = h[p++], a && !s.call(u, c) || (n[c] = u[c]);
            return n
        } : or,
        cr = function(e, t, n, i) {
            try {
        ...
        mr = function(e) {
            ...
            if (h && (u = rt(u, c > 2 ? arguments[2] : void 0, 2)), null == f || l == Array && fr(f))
                ...
                for (a = (r = f.call(s)).next, n = new l; !(i = a.call(r)).done; d++) o = h ? cr(r, u, [i.value, d], !0) : i.value, Fn(n, d, o);
            return n.length = d, n
        },
        gr = /[^\0-\u007E]/,
        vr = /[.\u3002\uFF0E\uFF61]/g,
                ...
                switch (a = r[u], c) {
                    ...
                    case Ya:
                        if (a == $r || "/" == a || "\\" == a && Ea(e) || !n && ("?" == a || "#" == a)) {
                            if (".." === (l = (l = h).toLowerCase()) || "%2e." === l || ".%2e" === l || "%2e%2e" === l ? (Oa(e), "/" == a || "\\" == a && Ea(e) || e.path.push("")) : Ia(h) ? "/" == a || "\\" == a && Ea(e) || e.path.push("") : ("file" == e.scheme && !e.path.length && xa(h) && (e.host && (e.host = ""), h = h.charAt(0) + ":"), e.path.push(h)), h = "", "file" == e.scheme && (a == $r || "?" == a || "#" == a))
    ...
    if (Ce("Number", !ss(" 0o1") || !ss("0b1") || ss("+0x1"))) {
        for (var hs, fs = function(e) {
                var t = arguments.length < 1 ? 0 : e,
                    n = this;
                return n instanceof fs && (cs ? r((function() {
                    ls.valueOf.call(n)
                })) : "Number" != h(n)) ? Xo(new ss(us(t)), n, fs) : us(t)
            }, ds = a ? is(ss) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), ps = 0; ds.length > ps; ps++) b(ss, hs = ds[ps]) && !b(fs, hs) && as(fs, hs, rs(ss, hs));
    ...
    var zs = l.f,
        Ws = function(e) {
            return function(t) {
                for (var n, i = m(t), r = Me(i), o = r.length, s = 0, l = []; o > s;) n = r[s++], a && !zs.call(i, n) || l.push(e ? [n, i[n]] : i[n]);
                return l
            }
        },
        Ks = {
    ...
    Pl && xl || (Pl = function(e) {
        ...
        delete jl[e]
    }, "process" == h(Cl) ? vl = function(e) {
        Cl.nextTick(Rl(e))
    } : Il && Il.now ? vl = function(e) {
        Il.now(Rl(e))
    ...
    var Ul, Dl, Fl, ql, Hl, Bl, Vl, zl, Wl = {
            set: Pl,
            clear: xl
        },
        Kl = A.f,
    ...
    Zl || (Ul = function() {
        ...
        Bl.data = Hl = !Hl
    }) : Xl && Xl.resolve ? (Vl = Xl.resolve(void 0), zl = Vl.then, ql = function() {
        zl.call(Vl, Ul)
    }) : ql = function() {
        $l.call(i, Ul)
    });
    var ec, tc, nc, ic, rc = Zl || function(e) {
            var t = {
                fn: e,
                next: void 0
            };
    ...
    if (a && Ce("RegExp", !uh || hh || r((function() {
        ...
        for (var fh = function(e, t) {
                var n, i = this instanceof fh,
                    r = qi(e),
                    a = void 0 === t;
            ...
            }, ph = ih(oh), mh = 0; ph.length > mh;) dh(ph[mh++]);
        ...
        bindMenuItemShortcuts: function(e, t) {
            ...
            Vu.call(this, e, "keydown keyup", (function(i) {
                if ([32, 38, 39, 40].includes(i.which) && (i.preventDefault(), i.stopPropagation(), "keydown" !== i.type)) {
                    ...
                    else 32 !== i.which && (40 === i.which || a && 39 === i.which ? (r = e.nextElementSibling, su(r) || (r = e.parentNode.firstElementChild)) : (r = e.previousElementSibling, su(r) || (r = e.parentNode.lastElementChild)), Uu.call(n, r, !0))
                }
    ...
    var nf = {
        ...
        ready: function() {
            ...
            var l, c = du(l = s) ? null : tu(Number(l)) ? l : l.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : l,
                u = Au("iframe"),
    ...
    var of = {
        ...
        ready: function() {
            ...
            if (du(t) || !t.startsWith("youtube-")) {
                ...
                var i, r, a = du(i = n) ? null : i.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/) ? RegExp.$2 : i,
    ...
    }(), cf = ct.findIndex, uf = !0, hf = Qt("findIndex");
